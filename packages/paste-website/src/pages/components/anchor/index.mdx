...
<NormalizedComponentHeader
  ...
  storybookUrl="/?path=/story/components-anchor--"
  data={props.data}
/>
...
When placing an Anchor within a sentence, don't link the whole sentence. Instead, only link the text that describes that describes where the user will go when they follow the link.

When the link is at the end of a sentence, avoid punctuation except for a question mark.
