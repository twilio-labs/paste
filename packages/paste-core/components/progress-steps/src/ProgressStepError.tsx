...
export const ProgressStepError = React.forwardRef<HTMLDivElement, ProgressStepErrorProps>((props, ref) => {
  validateProps(props);
  const {element = 'PROGRESS_STEP_ERROR', as = 'div', children, i18nErrorLabel = 'Error', ...rest} = props;
