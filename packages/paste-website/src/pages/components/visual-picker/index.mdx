...
Refer to the [Radio](/components/radio-group#composition-notes) and [Checkbox](/components/checkbox#composition-notes) composition notes for general guidance. Due to the visual nature of the component, avoid including more than two sentences in description text.
