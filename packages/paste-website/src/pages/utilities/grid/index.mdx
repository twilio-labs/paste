...
<LivePreview scope={{Grid, Column, Button, Box, Card, Heading, Paragraph}} language="jsx">
    ...
    <Column span={9}>
      <Box marginBottom="space50">
        <Card>
          ...
          <Text as="p" marginBottom="space0" textColor="colorTextWeak">BALANCE</Text>
          <Text as="p" marginBottom="space50" textColor="colorTextSuccess" fontWeight="fontWeightBold">$33.28</Text>
          <Text as="p" marginBottom="space0" textColor="colorTextWeak">REFERRAL PROGRAM</Text>
