...
export const pageQuery = graphql`
  {
    allPasteComponent(filter: {name: {eq: "@twilio-paste/media-object"}}) {
      edges {
        node {
          name
          description
...
<NormalizeComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/main/packages/core/components/media-object"
