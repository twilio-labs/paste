...
<ComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/main/packages/core"
...
The problem with importing this way is that the [referenced "main" file](https://github.com/twilio-labs/paste/blob/main/packages/core/components/button/package.json#L10)
