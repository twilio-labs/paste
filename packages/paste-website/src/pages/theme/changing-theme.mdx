...
If you're using Paste in Figma, you can swap between libraries using a native Figma feature. Find the [theme switching documentation](/theme/dark-theme#theme-switching) for more details.