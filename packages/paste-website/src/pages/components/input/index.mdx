...
**Note:** We do not support the native HTML `input[type="number"]` element due to some accessibility concerns. These are best described in the following [research article from the gov.uk digital team](https://technology.blog.gov.uk/2020/02/24/why-the-gov-uk-design-system-team-changed-the-input-type-for-numbers/).
