    ...
    <TabPanel>
      <Box marginBottom="space60">
        <Card>
          ...
          <Text as="p">Pattern is stable.</Text>
        </Card>
      </Box>
      <Box marginBottom="space60">
        <Table tableLayout="fixed">
          ...
          <TBody>
            <Tr>
              ...
              <Td>How to enable a user to generate a new object.</Td>
              <Td>Alpha</Td>
            </Tr>
            <Tr>
              <Td>
                <Anchor href="/patterns/delete">Delete</Anchor>
              </Td>
              <Td>How to enable a user to destroy an object.</Td>
              <Td>Alpha</Td>
            </Tr>
            <Tr>
              <Td>
                <Anchor href="/patterns/notifications">Notifications and feedback</Anchor>
              </Td>
              <Td>How to communicate timely information to users.</Td>
              <Td>Alpha</Td>
            </Tr>
            <Tr>
              <Td>
                <Anchor href="/patterns/object-details">Object details</Anchor>
              </Td>
              <Td>How to show a read-only page or panel of information about an object.</Td>
              <Td>Alpha</Td>
            </Tr>
          </TBody>
        </Table>
        ...
        <Table tableLayout="fixed">
          ...
          <TBody>
            ...
            <Tr>
              <Td>Onboarding</Td>
              <Td>
                How to take a user through a multi-step setup flow and teach them the benefits of a new product or
                feature.
              </Td>
              <Td>Open for contribution</Td>
            </Tr>
