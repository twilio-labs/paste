...
export const pageQuery = graphql`
  {
    denseLayout: file(
      ...
      relativePath: {eq: "images/foundations/localization/dense-layout.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
    ...
    textInImage: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/foundations/localization/text-in-image.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
...
<Callout>
  ...
  <CalloutText>
    This page contains general guidance around best practices for localization. If you have any questions, please
    contact the Localization team on Slack at #help-design-systems.
  </CalloutText>
</Callout>
...
<Img fluid={props.data.denseLayout.childImageSharp.fluid} />
...
<Img fluid={props.data.textInImage.childImageSharp.fluid} />
