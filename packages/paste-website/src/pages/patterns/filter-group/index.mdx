...
export const pageQuery = graphql`
  {
    defaultState: file(
      ...
      relativePath: {eq: "images/patterns/filter-default-state.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
    ...
    emptyState: file(sourceInstanceName: {eq: "assets"}, relativePath: {eq: "images/patterns/filter-empty-state.png"}) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
        }
...
<Img fluid={props.data.defaultState.childImageSharp.fluid} />
...
<Img fluid={props.data.emptyState.childImageSharp.fluid} />
...
<Callout>
  ...
  <CalloutText>
    ...
    consider partnering with us to [contribute it](/introduction/contributing/patterns/).
  </CalloutText>
</Callout>
