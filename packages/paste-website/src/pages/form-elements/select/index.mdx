...
<LivePreview scope={{Select, Option, FormHelpText, FormLabel}} language="jsx">
  {`<>
  <FormLabel hasError htmlFor="console_team" required>Console team</FormLabel>
  <Select
    id="console_team"
    htmlFor="console_team"
    required
...
<LivePreview scope={{Select, Option, FormHelpText, FormLabel}} language="jsx">
  {`<>
  <FormLabel disabled htmlFor="console_team" required>Console team</FormLabel>
  <Select
    id="console_team"
    htmlFor="console_team"
    disabled
...
<DoDont>
  <Do center title="Do" body="Sort options in a list logically (*e.g.*, alphabetically, ascending, descending).">
    <Box width="100%" padding="space60">
      <FormLabel htmlFor="sort_do">Which language do you use?Console team</FormLabel>
...
<DoDont>
  ...
  >
    <Box width="100%" padding="space60">
      <FormLabel htmlFor="sort_do">Caller IDConsole team</FormLabel>
      <Select id="sort_do" name="sort_do" onChange="">
  ...
  >
    <Box width="100%" padding="space60">
      <FormLabel htmlFor="sort_do">GenderConsole team</FormLabel>
      <Select id="sort_do" name="sort_do" onChange="">
