  ...
  <Table scrollHorizontally>
    ...
    <TBody>
      ...
      <Tr verticalAlign="top">
        ...
        <Td> **Change [thing]?** <br/> When you change [thing], your [objects] are deleted. <br/> Cancel | Change [thing] </Td>
      </Tr>
      <Tr verticalAlign="top">
        <Td> User wants to leave a flow but may want to save changes</Td>
        <Td> **Save changes?** <br/> If you close without saving, changes are lost. <br/> Close without saving | Save and close </Td>
      </Tr>
      <Tr verticalAlign="top">
