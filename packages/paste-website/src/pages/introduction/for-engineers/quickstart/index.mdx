...
- `src/App.tsx`: creates an `App` component, which wraps all pages. This is where the Paste [`<Theme.Provider>`](/theme/#theme-provider) is added which enables any child component to use tokens.
