...
If you make a [toast automatically time out](#showing-hiding-and-timing-out-a-toast), consider users that have different reading speeds, vision levels, and literacy levels (more details in the research insight below).

We recommend giving users about 0.5 seconds per word. For short toasts (about 5–10 words), give users about 2–4 seconds to read the toast message. For toasts at our [max suggested length of 140 characters](#composition-notes), that's about 30 seconds for about 55 English words. In this case, consider not making the toast automatically time out since the longer content length could also suggest that there's information worth persisting for the customer.
...
### Showing, hiding, and timing out a toast

<Callout variant="warning">
  <CalloutText>
    We'll be providing a more comprehensive method for displaying Toasts in the near future. Please bear with us.
  </CalloutText>
</Callout>
...
When showing multiple toasts, place the most recent toast at the bottom of the stack.
