...
```jsx
// import all ingredients for Object details patterns
...
The most common way to structure an object details page is to first show an overview of properties in a description list, followed by more detailed content sections. Properties should be left-aligned, and property labels and values should be horizontally placed.
