...
slug: /content/product-style-guide/
---
...
- Instead, write _the main menu_ or _the dropdown menu_. Name the component or area you’re referencing.
...
- _MM/DD/YYYY_ &mdash; this should be the most commonly used format in UI, e.g. for date stamps and in forms.
- _Day, Month DD, YYYY_, _Sunday, May 17, 2020_ &mdash; use this when referencing a specific date (e.g. _Your campaign will start on Tuesday, May 26, 2020_)
- A leading zero isn't needed for single digit dates, _3/12/2019_ not _03/12/2020_

**Do** indicate a date range by using a dash with no space.

- Range of less than a month within the same calendar year _4/12-4/18/2020_
- Range of more than a month within the same calendar year _5/12-5/18/2020_
...
<Callout>
  ...
  <CalloutText>
    ...
    the third person. Always check with the legal team if the content regards consent. If they suggest you use specific
    wording, <strong>use the wording the legal team suggests</strong>.
  </CalloutText>
</Callout>
