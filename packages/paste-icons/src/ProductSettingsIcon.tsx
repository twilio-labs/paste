...
const ProductSettingsIcon = React.forwardRef<HTMLElement, ProductSettingsIconProps>(
  ({ as, display, element = "ICON", size, color, title, decorative }, ref) => {
    const titleId = `ProductSettingsIcon-${useUID()}`;
