...
Keep any generated responses from the AI contained in the `AIChatMessageBody` component. Each chat message should only have one `AIChatMessageBody` component.import { AvatarExample } from "../../../component-examples/SkeletonLoaderExamples";
