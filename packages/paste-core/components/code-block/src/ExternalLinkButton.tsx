...
interface ExternalLinkButtonProps extends Omit<HTMLPasteProps<"button">, "tabIndex"> {
  href: string;
...
export const ExternalLinkButton: React.FC<React.PropsWithChildren<ExternalLinkButtonProps>> = ({
  ...
  return (
    <Tooltip text={tooltipText} element={`${element}_TOOLTIP`}>
      <Button as="a" variant="inverse" size="icon_small" href={href} element={element} target="_blank" {...props}>
