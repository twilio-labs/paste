...
- `pages/_app.tsx`: creates a `MyApp` component, which wraps all pages. This is where the Paste [`<Theme.Provider>`](/tokens/theme-package#theme-provider) is added which enables any child component to use tokens.
...
- `src/App.tsx`: creates an `App` component, which wraps all pages. This is where the Paste [`<Theme.Provider>`](/tokens/theme-package#theme-provider) is added which enables any child component to use tokens.
