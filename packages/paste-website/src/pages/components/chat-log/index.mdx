...
<LivePreview scope={{ChatMessage, ChatBubble}} language="jsx" noInline>
  {basicInboundMessage}
</LivePreview>
...
<LivePreview scope={{ChatMessage, ChatBubble, ChatMessageMeta, ChatMessageMetaItem, Avatar}} language="jsx" noInline>
  {inboundMessageMeta}
</LivePreview>

#### Outbound

<LivePreview scope={{ChatMessage, ChatBubble, ChatMessageMeta, ChatMessageMetaItem}} language="jsx" noInline>
  {outboundMessageMeta}
</LivePreview>
...
<LivePreview
  scope={{ChatMessage, ChatBubble, ChatAttachment, ChatAttachmentDescription, ChatAttachmentLink, DownloadIcon}}
  language="jsx"
  noInline
>
  {inboundMessageAttachment}
...
<LivePreview scope={{ChatEvent}} language="jsx" noInline>
  {basicChatEvent}
</LivePreview>
...
<LivePreview scope={{ChatBookend, ChatBookendItem}} language="jsx" noInline>
  {basicChatBookend}
</LivePreview>
...
<Callout>
  <CalloutTitle as="h4">Chat Log components are not in the Paste Component Library yet</CalloutTitle>
  <CalloutText>
