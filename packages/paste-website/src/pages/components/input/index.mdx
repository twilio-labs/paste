...
You can set the input to more [specific types](#input-types) if needed. It is used with the <Anchor href="/component/label">Label</Anchor> and <Anchor href="/component/help-text">Help Text</Anchor> components.
