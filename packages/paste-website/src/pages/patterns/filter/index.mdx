export const meta = {
  title: 'Filter',
  description: 'The filter pattern allows the user to filter lists, tables, and any other collection of data.',
...
- [Custom date range CodeSandbox example](https://codesandbox.io/s/custom-date-time-filter-group-unsgkp?file=/src/App.tsx)
