...
export interface PasteIconInverseProps {
  className?: string;
  color?: string;
  decorative?: boolean;
  display?: string;
...
const PasteIconInverse = React.memo(
  ({title = 'Twilio Paste', className, color, decorative = true, display, size}: PasteIconInverseProps) => {
