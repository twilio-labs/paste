...
<ComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/master/packages/paste-core/layout/grid"
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/layout-grid--grid-12-column-and-gutter-support"
...
use `vertical={[true, false, false]}`. For a visual example, [see the Storybook example](https://twilio-labs.github.io/paste/?path=/story/layout-grid--grid-2-column-responsive-stack)
...
For a visual example, [see the Storybook example](https://twilio-labs.github.io/paste/?path=/story/layout-grid--grid-2-column-responsive) and resize the browser.
...
Grid can also be used for responsive layouts.
 ...
 - You can determine what size columns should be based on the breakpoints set on a theme. [See the Storybook example](https://twilio-labs.github.io/paste/?path=/story/layout-grid--grid-2-column-responsive)
 - Grid columns can also stack based on theme breakpoints. [See the Storybook example](https://twilio-labs.github.io/paste/?path=/story/layout-grid--grid-2-column-responsive-stack)
