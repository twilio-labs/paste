...
4. For each new icon you would like to create, add an `svg` icon file into the `packages/paste-icons/svg/` folder.
5. From the root Paste folder, run the following command in your terminal: `yarn workspace @twilio-paste/icons convert-new`
...
7. At this point, run the following command to update our documentation with the new icons: `yarn workspace @twilio-paste/icons list-icons`
