...
—[People + AI Guidebook](https://pair.withgoogle.com/guidebook/patterns#anchor-on-familiarity), Google
</Blockquote>
...
- Design for poor data, common errors, biases, and customers being overly dependent on AI suggestions. Use the [error state pattern](https://paste.twilio.design/patterns/error-state) for ways to message errors.
...
To develop a prompt and personality for the chat assistant, use [Twilio’s Voice and Tone guidelines](/foundations/content/voice-and-tone#the-twilio-voice), especially emphasizing the “Conversational” principle of our guidelines.
