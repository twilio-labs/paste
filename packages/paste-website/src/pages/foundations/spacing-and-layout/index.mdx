...
<Image src={SpacingBlocks} placeholder="blur" alt="Visual representation of the 4-pixel and 8-pixel spacing grids" />
...
<Image src={FullPage} placeholder="blur" />
...
<Image src={SnappingMargins} placeholder="blur" />
...
<Image src={HorizontalSpacing} placeholder="blur" />
