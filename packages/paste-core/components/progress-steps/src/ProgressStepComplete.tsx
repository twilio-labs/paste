...
export const ProgressStepComplete = React.forwardRef<HTMLDivElement, ProgressStepCompleteProps>((props, ref) => {
  validateProps(props);
  const {element = 'PROGRESS_STEP_COMPLETE', as = 'div', children, i18nCompleteLabel = 'Complete', ...rest} = props;
