...
const ComponentCardHeader: React.FC<React.PropsWithChildren<unknown>> = ({children}) => {
  return (
...
const ComponentCardIllustration: React.FC<React.PropsWithChildren<unknown>> = ({children}) => {
  return (
...
const ComponentCardFooter: React.FC<React.PropsWithChildren<unknown>> = ({children}) => {
  return (
...
const ComponentCard: React.FC<React.PropsWithChildren<unknown>> = ({children}) => {
