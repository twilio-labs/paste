...
export const TimelineDoTimestamp = `
const TimelineStart = () => {
  return (
    <Timeline>
      <TimelineItem title="Event title" timestamp="August 30, 2024">
...
export const TimelineDontTimestamp = `
const TimelineStart = () => {
  return (
    <Timeline>
      <TimelineItem title="Event title" timestamp="August 30, 2024">
...
export const TimelineDontIcon = `
const TimelineStart = () => {
  return (
    <Timeline>
      <TimelineItem title="Event title" timestamp="August 30, 2024" icon={ProcessInProgressIcon}>
        Sending
      </TimelineItem>

      <TimelineItem title="Event title" timestamp="August 29, 2024" icon={WarningIcon}>
        Undelivered
      </TimelineItem>
    </Timeline>
  );
