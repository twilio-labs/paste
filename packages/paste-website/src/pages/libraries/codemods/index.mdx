...
<ComponentHeader
  ...
  packageName={props.data.allPasteLibraries.edges[0]?.node.name}
  version={props.data.allPasteLibraries.edges[0]?.node.version}
  description={props.data.allPasteLibraries.edges[0]?.node.description}
  status={props.data.allPasteLibraries.edges[0]?.node.status}
/>
