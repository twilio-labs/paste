...
If the user has not yet created any instances of this object, they should see an empty state with a create action within it. Follow the [empty state (coming soon!)](/patterns/empty-state) pattern in this case.
