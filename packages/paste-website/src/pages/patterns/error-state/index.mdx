...
<Table tableLayout="fixed" striped>
  ...
  <TBody>
    <Tr verticalAlign="top">
      <Td>An error generating or regenerating a response</Td>
      <Td>There was an error generating a response. <br />Please try again, if the error persists please contact us.</Td>
      <Td>If the error is associated to the user’s input having incomplete information use “Please rephrase your message”</Td>
    </Tr>
  </TBody>
</Table>
<br />
