...
<ResponsiveImage src={CreateStandardImage} alt="table with a primary action button placed at the top right" />
...
<ResponsiveImage src={CreateMultiOptionImage} alt="table with a primary action button that opened a menu" />
...
<ResponsiveImage src={CreateAnchorImage} alt="table with a primary action link" />
...
<ResponsiveImage src={CreateAnchorAsButtonImage} alt="table with primary action link styled as a button" />
...
<ResponsiveImage src={CreateSubSectionImage} alt="table inside of a tab with a primary action button" />
