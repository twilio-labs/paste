...
[SF Pro](https://developer.apple.com/fonts/) is the system font for Apple platforms. We represent native web element styles (like option lists in [Select](/components/select/)) in our design assets in macOS styles.
