...
value is formatted according to the <Anchor href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/date#value" showExternal>locale of the user's browser</Anchor>.
