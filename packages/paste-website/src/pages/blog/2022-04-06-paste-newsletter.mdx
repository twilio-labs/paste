export const meta = {
  ...
  external_link: null,
  excerpt:
    "What's new in Paste in April 2022? i18n, dark theme, badge component updates, data visualization, and more!",
};
...
import PillGroup from '../../assets/images/articles/2022-04-06-paste-newsletter/i18n-pill-group.png';
import DarkSwitcher from '../../assets/images/articles/2022-04-06-paste-newsletter/dark-theme-switcher.png';
import Badge2 from '../../assets/images/articles/2022-04-06-paste-newsletter/badge-2.png';
import FilterGroup from '../../assets/images/articles/2022-04-06-paste-newsletter/filter-group-pattern-demo.png';
import DataViz from '../../assets/images/articles/2022-04-06-paste-newsletter/data-visualization-demo.png';
import PasteMates from '../../assets/images/articles/2022-04-06-paste-newsletter/pastemates.png';
...
<Image src={PillGroup} alt="An example of Paste's form-pill-group component in French" placeholder="blur" />
...
<Image
  src={DarkSwitcher}
  alt="An screenshot of the dark theme toggle on the Paste website, with dark theme selected"
  placeholder="blur"
/>
...
<Image src={Badge2} alt="The new and improved Badge component in Paste" placeholder="blur" />
...
<Image src={FilterGroup} alt="Screenshot of a Filter Group pattern example" placeholder="blur" />
...
<Image src={DataViz} alt="Screenshot of a line chart using Paste data visualization tokens" placeholder="blur" />
...
<Image
  src={PasteMates}
  alt="Photo of this month's Pastemates. Left: Kate Hsiao. Center: Tess Hannel. Right: Zach Kuzmic."
  placeholder="blur"
/>
...
<Callout variant="neutral" marginY="space70">
  <CalloutHeading as="h3">Roadmap delays inbound</CalloutHeading>
  <CalloutText>
