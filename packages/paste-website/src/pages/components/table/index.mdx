...
Avoid documenting an entire error message within a row. Use an indicator, like an icon or an icon with a short message. Then use other methods, like a popup, side sheet, or full page to communicate complete error and resolution information. 

**When multiple errors affect a single row,** indicate the number of errors and provide specific error and resolution information within a popover, side sheet, or full page.
