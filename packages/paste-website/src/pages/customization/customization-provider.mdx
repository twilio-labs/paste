export const meta = {
  ...
  package: '@twilio-paste/customization',
...
<GenericHeader
  ...
  storybookUrl="?path=/story/theme-customization--"
...
<Callout variant="warning" marginY="space70">
  <CalloutHeading as="h2">This page is for Twilio customers only!</CalloutHeading>
  <CalloutText>
    ...
    on how and when to build custom components in a Twilio product.
  </CalloutText>
</Callout>
...
Similar to the Paste [ThemeProvider](/theme), the `CustomizationProvider` uses [React Context](https://reactjs.org/docs/context.html) to provide a [theme object](/theme/#theme) to any descendant components in the tree.
