...
<ComponentHeader
  ...
  packageName={props.data.allPasteThemePackage.edges[0].node.name}
  version={props.data.allPasteThemePackage.edges[0].node.version}
  description={props.data.allPasteThemePackage.edges[0].node.description}
/>
