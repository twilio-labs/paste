...
import {
  ...
  helpTextCheckboxExample,
  requiredCheckboxExample,
  checkboxDisclaimerExample,
...
<Callout variant="warning">
  ...
  <CalloutText>
    Checkboxes should be used as <strong>controlled components</strong> or with a form library that handles the control
    for you.
  </CalloutText>
</Callout>
...
<LivePreview scope={{Checkbox}} language="jsx" noInline>
  {singleCheckboxExample}
</LivePreview>
...
<LivePreview scope={{CheckboxDisclaimer, Text}} language="jsx" noInline>
  {checkboxDisclaimerExample}
</LivePreview>
