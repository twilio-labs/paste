...
<ComponentHeader
  ...
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/components-input--input-options"
...
<LivePreview scope={{Input, Label, HelpText}} language="jsx">
  ...
  <Input aria-describedby="payment_amount_help_text" id="payment_amount" name="payment_amount" type="text" placeholder="124.45" insertBefore={<div>$</div>} onChange="" required />
  <HelpText id="payment_amount_help_text">Enter a dollar amount is USD format</HelpText>
</>`}
</LivePreview>
...
<LivePreview scope={{Input, Label, HelpText, InformationIcon, Button}} language="jsx">
  ...
  <Input
    ...
    onChange=""
  />
  <HelpText id="display_name_help_text">Please enter a short title for your message</HelpText>
</>`}
</LivePreview>
...
<LivePreview scope={{Input, Label, HelpText}} language="jsx">
  ...
  <HelpText id="email_readonly_help_text">Please enter a valid email</HelpText>
</>`}
</LivePreview>
...
<DoDont>
  <Do title="Do" body="Use help text to help users prevent errors and fill out a form field correctly." center>
    <Box width="100%" padding="space60">
      ...
      <Input aria-describedby="email_do_help_text" id="email_do" name="email_do" type="email" placeholder="example@twilio.com" onChange=""/>
...
<DoDont>
  ...
  <Dont title="Don't" body="Don't use more than 2 sentences in help text or error text." center>
    <Box width="100%" padding="space60">
      ...
      <HelpText id="help_dont_help_text">Go to your settings. Then click on email addresses. After doing that, copy and paste your email address in this field.</HelpText>
    </Box>
  </Dont>
</DoDont>
<DoDont>
  ...
  <Dont title="Don't" body="Don't use prefix/suffix text as a replacement for a label." center>
    <Box width="100%" padding="space60">
      <Input id="label_dont" name="label_dont" type="text" onChange="" insertBefore="Name"/>
    </Box>
  </Dont>
</DoDont>
<DoDont>
