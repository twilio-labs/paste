...
<Image src={ButtonPrimaryActionImage} placeholder="blur" alt="table with a primary create new action button" />
...
<Image src={ButtonMultipleActionsImage} placeholder="blur" alt="table with multiple action buttons" />
...
<Image
  src={ButtonAnchorLikeButtonsImage}
  placeholder="blur"
...
<Image src={ButtonCardExternalAnchorImage} placeholder="blur" alt="card layout with internal and external anchors" />
