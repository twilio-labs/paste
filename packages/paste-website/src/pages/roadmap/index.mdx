...
<AnchoredHeading tag="Current Release">Release 0.3</AnchoredHeading>

Codenamed *Oh Point Three*. This release is _expected_ to land in the last week of October.

### Component Updates

**Text &amp; Box Primitive**<br/>
...
**Heading, Paragraph Components**<br/>
...
**Grid Component (Design Preview)**<br/>
...
**Alert &amp; Toast Components (Design Preview)**<br/>
...
Codenamed *that one after Oh Point Three*. This release is _expected_ to land in the third week of November. Thie release is *not locked in*, but here are candidates for the release.
...
We are working hard on a unique codename for this release. It is _expected_ to land in the first week of January, 2020. Thie release is *not locked in*, but here are candidates for the release.
