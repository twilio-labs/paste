...
export const FAIL_MESSAGE = `You have create a new Paste website page, but have not added a corresponding VRT entry.
Please update the VRT sitemap file to test new website pages added to Paste.`;
