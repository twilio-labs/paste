...
<Callout>
  <CalloutText>
    Codenamed <strong>Oh! Point Three!</strong> This release is expected to land in the <em>last week of October.</em>
  </CalloutText>
</Callout>
...
<Callout>
  <CalloutText>
    Codenamed <strong>that one after Oh! Point Three!</strong> This release is expected to land in the{' '}
    <em>third week of November</em>. This release is <em>not locked in</em>, but here are candidates for the release.
  </CalloutText>
</Callout>
...
<Callout>
  <CalloutText>
    We are working hard on a unique codename for this release. This release is expected to land in the{' '}
    <em>first week of January, 2020</em>. This release is <em>not locked in</em>, but here are candidates for the
    release.
  </CalloutText>
</Callout>
