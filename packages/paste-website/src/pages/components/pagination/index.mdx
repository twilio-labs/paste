...
<ComponentHeader
  ...
  abstractUrl="https://www.figma.com/file/E6KUvMhioUmAgN0nwmReTM/Paste-Components?node-id=1469%3A0"
...
Consider [contributing a Table Actions pattern](/patterns/contribute) to help standardize this across Twilio!
      ...
      <Tr>
        ...
        <Td>
          <UnorderedList marginBottom="space0">
            <ListItem>Hover: $color-background-primary-lightest</ListItem>
          </UnorderedList>
        </Td>
        <Td>No</Td>
      </Tr>
      <Tr>
        ...
        <Td>
          <UnorderedList marginBottom="space0">
            ...
            <ListItem>Hover: $color-border-primary</ListItem>
            <ListItem>Focus: $color-border-primary</ListItem>
          </UnorderedList>
        </Td>
        <Td>No</Td>
      </Tr>
      <Tr>
        ...
        <Td>
          <UnorderedList marginBottom="space0">
            ...
            <ListItem>Hover: $color-text-link</ListItem>
            <ListItem>Focus: $color-text-link</ListItem>
          </UnorderedList>
        </Td>
        <Td>No</Td>
      </Tr>
    ...
    <TBody>
      <Tr>
        ...
        <Td>
          <UnorderedList marginBottom="space0">
            ...
            <ListItem>Current: $color-background-primary-lightest</ListItem>
            <ListItem>Hover: $color-background-primary-lightest</ListItem>
            <ListItem>Focus: $color-background-primary-lightest</ListItem>
          </UnorderedList>
        </Td>
        <Td>No</Td>
      </Tr>
      <Tr>
        ...
        <Td>
          <UnorderedList marginBottom="space0">
            <ListItem>$color-text</ListItem>
            <ListItem>Current: $color-text-link</ListItem>
            <ListItem>Hover: $color-text-link</ListItem>
            <ListItem>Focus: $color-text-link</ListItem>
          </UnorderedList>
        </Td>
