...
description: Notes on how to get started as a designer with installing and using Paste
...
<Callout variant="information">
  ...
  <CalloutText>
    ...
    <Anchor href="https://help.abstract.com/best-practices/">best practices</Anchor>.
  </CalloutText>
</Callout>
...
to [download and install Inter](https://github.com/rsms/inter/releases/download/v3.15/Inter-3.15.zip).
...
If you are using any theme in Paste, you will need to [download and install SF Pro](https://developer.apple.com/fonts/), the
...
<Callout variant="information">
  ...
  <CalloutText>
    ...
    <Anchor href="https://help.abstract.com/libraries/link-libraries/">this guide</Anchor> to learn how.
  </CalloutText>
</Callout>
...
>
  <Stack as="span" orientation="horizontal" spacing="space20">
    ...
    <Text as="p">Libraries in this project are actively maintained</Text>
  </Stack>
</Box>
...
>
  <Stack as="span" orientation="horizontal" spacing="space20">
    ...
    <Text as="p">Libraries in this project are sunset or deprecated</Text>
  </Stack>
</Box>
...
>
  <Stack as="span" orientation="horizontal" spacing="space20">
    ...
    <Text as="p">This library is sunset</Text>
  </Stack>
</Box>
...
>
  <Stack as="span" orientation="horizontal" spacing="space20">
    ...
    <Text as="p">This project is deprecated</Text>
  </Stack>
</Box>
