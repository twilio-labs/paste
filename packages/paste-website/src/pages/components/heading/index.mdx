...
Keep headings concise. You can omit articles depending on the context. If the user would be prioritizing efficiency, leave out articles. If the content is more casual, include the articles.
