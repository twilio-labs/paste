...
<ComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/master/packages/paste-core/components/screen-reader-only"
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/components-screen-reader-only--default"
