...
export const PasteMDXProvider: React.FC<PasteMDXProviderProps> = (props: PasteMDXProviderProps): React.ReactElement => {
  return (
    <MDXProvider
      components={{
        ...shortcodes,
        h1: (props: Heading): React.ReactElement => <Heading {...props} as="h1" variant="heading60" />,
        h2: (props: Heading): React.ReactElement => <AnchoredHeading {...props} as="h2" variant="heading50" />,
        h3: (props: Heading): React.ReactElement => <AnchoredHeading {...props} as="h3" variant="heading40" />,
        h4: (props: Heading): React.ReactElement => <AnchoredHeading {...props} as="h4" variant="heading30" />,
        h5: (props: Heading): React.ReactElement => <AnchoredHeading {...props} as="h5" variant="heading20" />,
        h6: (props: Heading): React.ReactElement => <AnchoredHeading {...props} as="h6" variant="heading10" />,
