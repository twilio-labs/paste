---
title: Screen Reader Only - Layout
...
export const pageQuery = graphql`
  {
    allPasteLayout(filter: {name: {eq: "@twilio-paste/screen-reader-only"}}) {
      edges {
        node {
          name
          description
...
<ComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/master/packages/paste-core/layout/screen-reader-only"
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/layout-screen-reader-only--default"
