...
- [Stylized Ordered Lists](/components/list#stylized-ordered-list) structure tasks but don’t outline or show progression or status through a multi-step task.
