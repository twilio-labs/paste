...
slug: /articles/2021-07-21-pastes-path-to-a-transparent-package-categorization-system/
date: 2021-07-21
author: Nora Krantz
...
export const pageQuery = graphql`
  {
    mdx(fields: {slug: {eq: "/articles/2021-07-21-pastes-path-to-a-transparent-package-categorization-system/"}}) {
      fileAbsolutePath
      frontmatter {
        slug
        title
    ...
    overview1: file(
      ...
      relativePath: {eq: "images/articles/pastes-path-to-a-transparent-package-categorization-system/overview-1.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 500) {
    ...
    overview2: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/articles/pastes-path-to-a-transparent-package-categorization-system/overview-2.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 500) {
          ...GatsbyImageSharpFluid
...
_When integrating a library into a project, you’ll likely want to ensure that it’s a mature and well-maintained library that won’t be deprecated a month down the line. If your project is a customer-facing platform and the library maintains your frontend components, all the more reason to have trust. Transparency between the library and the consumer is integral to building that trust._

### Our old component maturity system
...
<Box marginBottom="space70">
  <Img
    fluid={props.data.overview1.childImageSharp.fluid}
    alt="Screenshot of the Component Overview page before we changed our categorization system"
  />
</Box>
...
<Box marginBottom="space70">
  <Img
    fluid={props.data.overview2.childImageSharp.fluid}
    alt="Screenshot of the Component Overview page after we updated our categorization system"
  />
</Box>
