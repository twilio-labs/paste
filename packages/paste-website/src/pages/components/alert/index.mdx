...
<Box marginBottom="space40">
  <Alert variant="warning">
    <Text as="span">
      <strong>James Baldwin:</strong> Love takes off masks that we fear we cannot live without and know we cannot live within.
    </Text>
  </Alert>
</Box>
<Box marginBottom="space40">
...
<DoDont>
  ...
  >
    <Alert variant="neutral">
      <Text as="span">
        A call to action <Anchor href="#">Click here</Anchor>
      </Text>
    </Alert>
  </Do>
