...
<LivePreview scope={{Stack, Card, Paragraph, Heading, Button}} language="jsx">
  {`<Stack orientation="vertical" spacing="space40">
    <Card padding="space120">
      ...
      <Button as="a" href="https://www.transgenderdistrictsf.com/">Support The Transgender District</Button>
    </Card>
    <Card padding="space120">
      ...
      <Button as="a" href="https://insideoutys.org/">Support Inside Out</Button>
    </Card>
    <Card padding="space120">
      ...
      <Button as="a" href="https://alp.org/">Support The Audre Lorde Project</Button>
    </Card>
  </Stack>`}
</LivePreview>
