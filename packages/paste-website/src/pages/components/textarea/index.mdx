...
A textarea allows users to enter text on multiple lines. It is used with the <Anchor href="/components/label">Label</Anchor> and <Anchor href="/components/help-text">Help Text</Anchor> components.
