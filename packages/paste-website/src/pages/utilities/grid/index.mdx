...
<Callout variant="warning">
  ...
  <CalloutText>When using <strong>span</strong> or <strong>offset</strong>, base your layout off a 12-column grid. For example, if you want to have two columns with one spanning twice as much as the other, then one column would span=8 and the other would span=4.</CalloutText>
</Callout>
