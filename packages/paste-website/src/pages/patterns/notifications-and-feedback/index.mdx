...
<Image src={NotificationsAlertImage} placeholder="blur" alt="Screen with alert informing users of a server error" />
...
<Image src={NotificationsModalImage} placeholder="blur" alt="Modal congratulating a user at the end of a Modal flow" />
...
<Image
  src={NotificationsInlineMessagingImage}
  placeholder="blur"
