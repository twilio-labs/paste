...
import {Badge, StatusBadge} from '@twilio-paste/badge';
...
<NormalizedComponentHeader
  ...
  storybookUrl="/?path=/story/components-badge--"
  data={props.data}
/>
...
Following the [Paste Status Pattern](/patterns/status), Status Badges can be used in cases where a Badge represents either a Process or Availability. These composed Status Badges choose the right color and icon pairing for you, based on the variant you choose. The variants available are mapped to the Status Pattern.
...
<LivePreview scope={{Box, StatusBadge}} language="jsx">
  ...
  <Box display="flex" columnGap="space40">
    <StatusBadge as="span" variant="AvailabilityAvailable">
      Available
    </StatusBadge>
    <StatusBadge as="span" variant="AvailabilityUnavailable">
      Unavailable
    </StatusBadge>
    <StatusBadge as="span" variant="AvailabilityBusy">
      Busy
    </StatusBadge>
    <StatusBadge as="span" variant="AvailabilityNeutral">
      Neutral
    </StatusBadge>
    <StatusBadge as="span" variant="AvailabilityOffline">
      Offline
    </StatusBadge>
  </Box>
</Box>
...
All the same props as Badge, with different variants.
