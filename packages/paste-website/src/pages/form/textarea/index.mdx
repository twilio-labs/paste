...
import {FormLabel, FormInput, FormHelpText, FormTextArea} from '@twilio-paste/form';
...
<LivePreview scope={{FormLabel, FormTextArea}} language="jsx">
  ...
  <FormTextArea aria-describedby="text_disabled_help_text" id="text_disabled" name="text_disabled" placeholder="Enter a description..." disabled />
</>`}
</LivePreview>
...
<LivePreview scope={{FormLabel, FormTextArea}} language="jsx">
  ...
  <FormTextArea aria-describedby="text_readonly_help_text" id="text_readonly" name="text_readonly" readOnly>Paste is a design system used to build accessible, consistent, and high quality customer experiences at Twilio. Paste is open source and contributions are welcome.</FormTextArea>
</>`}
</LivePreview>
