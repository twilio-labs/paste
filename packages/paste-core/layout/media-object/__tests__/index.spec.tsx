...
describe('Customization', () => {
  it('should add custom styles to MediaObject', (): void => {
    render(
      ...
      >
        <CustomizableMediaObject data-testid="customizable-media-object">Custom media-object</CustomizableMediaObject>
      </CustomizationProvider>
    );
  ...
  it('should add custom styles to MediaFigure', (): void => {
    render(
      ...
      >
        <CustomizableMediaFigure data-testid="customizable-media-figure">Custom media-figure</CustomizableMediaFigure>
      </CustomizationProvider>
    );
  ...
  it('should add custom styles to MediaBody', (): void => {
    render(
      ...
      >
        <CustomizableMediaBody data-testid="customizable-media-body">Custom media-body</CustomizableMediaBody>
      </CustomizationProvider>
    );
