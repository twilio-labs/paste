...
The 'Paste design tokens' project houses the text and layer styles
...
theme you see in Console) and `default theme` (this is the new unified theme, formerly known as UDL.
...
<Callout variant="warning">
  <CalloutTitle>
    A note on the SendGrid components
  </CalloutTitle>
  <CalloutText>
...
The `heading` symbols represent our <Anchor href="/components/heading">Heading</Anchor> component and include H1 through H6. You can find the
