...
description: Best practices for button and anchor usage.
...
<Callout variant="warning">
  ...
  <CalloutText>
    ...
    please create a <Anchor href="https://github.com/twilio-labs/paste/discussions">GitHub Discussion</Anchor> and let
    us know.
  </CalloutText>
</Callout>
...
## Best Practices for Button and Anchor Usage spec

[Link to example designs](https://www.figma.com/file/E6KUvMhioUmAgN0nwmReTM/Paste-Components?node-id=400%3A851)
...
<UnorderedList>
  ...
  <ListItem>
    <Anchor href="/components/button#destructive-button">Desctructive button</Anchor>
  </ListItem>
  <ListItem>
    <Anchor href="/components/button#destructive-secondary-button">Secondary desctructive button</Anchor>
  </ListItem>
  <ListItem>
    <Anchor href="/components/button#link-style-button">Link-style desctructive button</Anchor>
  </ListItem>
  <ListItem>
    Primary button-style anchor{' '}
    <Text as="span" color="colorTextNew" fontStyle="italic">
      New!
    </Text>
  </ListItem>
  <ListItem>
    Secondary button-style anchor{' '}
    <Text as="span" color="colorTextNew" fontStyle="italic">
      New!
    </Text>
  </ListItem>
...
<Callout variant="warning">
  <CalloutText>🚨 This is not a variant we recommend you use often.</CalloutText>
</Callout>

But, If you need to add additional, less-visually competitive actions on a page, use a link-style button. If you've exhausted the use of primary and secondary buttons, a link-style button is the way to go. Again, when using buttons that look similar to anchors, **be very strategic** in their use since voice dictation users may encounter issues when trying to activate them by mistaking them for anchors.
...
**External link icon:** When the user is being taken outside of the product
...
Again, when using anchors that look like buttons, be very strategic in their use as dictation software users may experience usability issues.
...
<LivePreview scope={{Button, ArrowForwardIcon, Stack}} language="jsx">
  {`<Stack orientation="horizontal" spacing="space30">
