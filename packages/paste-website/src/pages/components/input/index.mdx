...
You can set the input to more [specific types](#input-types) if needed. It is used with the <Anchor href="/components/label">Label</Anchor> and <Anchor href="/components/help-text">Help Text</Anchor> components.
