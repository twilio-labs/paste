...
<LivePreview scope={{Box, Text, LoadingIcon}} language="jsx">
  {`<Text textColor="colorTextInverse">
  <Box display="flex" alignItems="center" backgroundColor="colorBackgroundInverse" padding="space30" borderRadius="borderRadius20">
...
<LivePreview scope={{PlusIcon}} language="jsx">
  {`<p>
