export const meta = {
  ...
  slug: '/components/icon/usage-guidelines/',
};
...
<Callout variant="neutral" marginY="space70">
  <CalloutHeading as="h2">Can't find the icon you need?</CalloutHeading>
  <CalloutText>
    Check <Anchor href="https://streamlineicons.com/">Streamline</Anchor> and contribute it to the library following{' '}
    <SiteLink href="/introduction/contributing/icons">our guidelines.</SiteLink>
  </CalloutText>
</Callout>
...
Our icons require the developer define whether an icon is decorative by [providing the required property](/components/icon/usage-guidelines#making-an-icon-decorative-or-informative).
...
performance benefits](/components/icon/usage-guidelines#why-react-components). As our icon set grows to contain over 100 icons, we don't
