...
import {FullSettingsExample, SettingsOverviewExample} from '../../../component-examples/page-templates/SettingsExamples';
...
<StoryPreview
  title="Settings page template - full"
  storyID="website-pagetemplateexamples--full-settings-example"
  code={FullSettingsExample}
/>
...
<StoryPreview
  title="Settings page template - full"
  storyID="website-pagetemplateexamples--settings-overview-example"
  code={SettingsOverviewExample}
/>
