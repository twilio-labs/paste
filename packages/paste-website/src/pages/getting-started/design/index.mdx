...
<Callout variant="information">
  <CalloutTitle>Migrating from Sketch to Figma</CalloutTitle>
  <CalloutText>
    A{' '}
    <Anchor href="https://docs.google.com/document/d/1IOBY2kxdHB6b8nlSWIFOLK7TKTV-Xxv7czzCZIVTAxg/edit#heading=h.ovpqdunx7hsp">
      full migration and onboarding guide
    </Anchor>{' '}
    has been created to help with the transition to Figma.
  </CalloutText>
</Callout>

Product designers across Twilio use Figma to design their UIs. You can [file a ticket with IT](https://twilio.service-now.com/sp/)
to get a Figma license.
...
## How to use Figma libraries

For every Figma project, you will need to link the necessary Paste libraries in order to use the
components, text, and layer styles.

### Linking the libraries

You will need to "link" the Paste libaries to get all the components, text, and layer styles in your design files.
...
in the [`Paste Components` Figma library](/getting-started/design#paste-components-library).
...
### Safely accepting library updates (in legacy Abstract)
