...
export const pageQuery = graphql`
  {
    allPasteComponent(filter: {name: {eq: "@twilio-paste/aspect-ratio"}}) {
      edges {
        node {
          name
          description
    ...
    mdx(fields: {slug: {eq: "/components/aspect-ratio/"}}) {
      fileAbsolutePath
      frontmatter {
        slug
        title
...
<NormalizeComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/main/packages/core/components/aspect-ratio"
