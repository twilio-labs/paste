...
If you want to show information that can't be edited, use a [read-only](/input#read-only-input) field or consider another way of showing static information.
