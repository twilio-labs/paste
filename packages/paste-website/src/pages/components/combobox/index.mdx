...
<LivePreview scope={{Combobox, Anchor, InformationIcon, Text}} noInline language="jsx">
  {prefixSuffixExample}
</LivePreview>
...
<LivePreview scope={{Combobox, Box, Button, CloseIcon, SearchIcon, useCombobox}} noInline language="jsx">
  {stateHookCombobox}
</LivePreview>
