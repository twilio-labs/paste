...
### Hiding Corner Ornament

Hiding the ornament and removing the cutout are not supported by this component. Since this component is composable and the base element you are wrapping will look the same if you remove the corner ornament, we recommend removing the Corner Ornament components from the DOM tree if you want to hide the ornament.
## Variants
