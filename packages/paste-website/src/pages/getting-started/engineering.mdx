...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>@styled-system/css</td>
      <td>{Package.dependencies['@styled-system/css']}</td>
    </tr>
  </tbody>
</table>

```shell
yarn add react react-dom prop-types react-uid @emotion/core @emotion/styled styled-system @styled-system/theme-get @styled-system/css
```
...
```shell
yarn add @twilio-paste/types @twilio-paste/style-props @twilio-paste/design-tokens @twilio-paste/theme @twilio-paste/icons
```
...
const App = () => <Theme.Provider theme="default">// other stuff here</Theme.Provider>;
```
