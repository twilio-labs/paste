...
## Useful resources
    ...
    - [Sketch Runner](https://sketchrunner.com/): Download the free version of Runner to install any plugin right from Sketch. [Learn how to install install a Sketch plugin.](https://www.sketch.com/docs/plugins/) For the following plugins, once you've installed Runner, go to Plugins > Runner > Install, then search for the plugin.
    - [Camilo](https://github.com/Pausansol/Camilo): Swaps Sketch libraries (e.g., from `console theme.sketch` to `default theme.sketch`).
    - [Symbol Swapper](https://github.com/sonburn/symbol-swapper): Swaps all symbol instances in a file (e.g., swaps all destructive primary button symbols in Console theme to destructive primary buttons in Default theme).
