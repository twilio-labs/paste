...
import FigmaOpenLibrary from '../../../../assets/images/design-guidelines/figma-open-library-modal.png';
import PasteLibraries from '../../../../assets/images/design-guidelines/figma-link-paste-libraries.png';
...
<Image src={FigmaOpenLibrary} alt="Buttons to click in Figma to open the library selector" placeholder="blur" />

<Image
  src={PasteLibraries}
  alt="Modal in Figma where you can select the Paste components library to link to your project"
  placeholder="blur"
/>
...
[Twilio Sans Mono](https://github.com/twilio/twilio-sans-mono) is a beautiful and extensive open source programming font.
