...
export const pageQuery = graphql`
  {
    developOrMonitor: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/experiences/console/develop-or-monitor.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
    ...
    betaTag: file(sourceInstanceName: {eq: "assets"}, relativePath: {eq: "images/experiences/console/beta-tag.png"}) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
        }
    ...
    breadcrumbExample: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/experiences/console/breadcrumb-example.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
    ...
    productExplorer: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/experiences/console/product-explorer.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
    ...
    regional1: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/experiences/console/regional-1.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
    ...
    regional2: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/experiences/console/regional-2.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
    ...
    regional3: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/experiences/console/regional-3.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
    ...
    regional4: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/experiences/console/regional-4.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
    ...
    regional5: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/experiences/console/regional-5.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
    ...
    serviceListServiceDetail: file(
      sourceInstanceName: {eq: "assets"}
      relativePath: {eq: "images/experiences/console/service-list-service-detail.png"}
    ) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid
...
<Img fluid={props.data.developOrMonitor.childImageSharp.fluid} />
<ImageCaption>
...
<Img fluid={props.data.serviceListServiceDetail.childImageSharp.fluid} />
<ImageCaption>
...
<Img fluid={props.data.breadcrumbExample.childImageSharp.fluid} />
...
<Img fluid={props.data.betaTag.childImageSharp.fluid} />
<ImageCaption>A beta tag being used in Console to identify and describe a beta-stage product.</ImageCaption>
...
<Img fluid={props.data.productExplorer.childImageSharp.fluid} />
...
- On the product explorer page, the product card should have a dropdown caret next to the pin allowing the user to pin the product to the desired region.
  ...
  <Img fluid={props.data.regional1.childImageSharp.fluid} />
  <ImageCaption>Example of a product with a pinned region</ImageCaption>
  <br />
  <br />
...
<Img fluid={props.data.regional2.childImageSharp.fluid} />
...
<Img fluid={props.data.regional3.childImageSharp.fluid} />
...
<Img fluid={props.data.regional4.childImageSharp.fluid} />
...
<Img fluid={props.data.regional5.childImageSharp.fluid} />
