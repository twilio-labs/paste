...
const CopyIconWithTooltip: React.FC<{name: DecoratedToken['name']}> = ({name}) => {
  const {tooltipText, tooltipState, isCopied, handleCopyName} = useCopyIconName(name);
  return (
...
CopyIconWithTooltip.displayName = 'CopyIconWithTooltip';

export {CopyIconWithTooltip};
