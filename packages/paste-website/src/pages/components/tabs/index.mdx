...
| variant?     | "fitted", "inverse", "inverse_fitted", "undefined" | Changes each Tab to either equally fit the width of the containing element or hug the contents of its label.                 | "undefined"                          |
