...
<LivePreview scope={{Table, THead, TBody, Tr, Th, Td, Text}} language="jsx" overflowScroll>
  {`<Table>
  <THead>
    <Tr>
      <Th>Date</Th>
...
<LivePreview scope={{Table, THead, TBody, TFoot, Tr, Th, Td, Text}} language="jsx" overflowScroll>
...
<LivePreview scope={{Table, THead, TBody, Tr, Th, Td}} language="jsx" overflowScroll>
  {`<Table>
  <THead>
    <Tr>
...
<LivePreview scope={{Table, THead, TBody, TFoot, Tr, Th, Td, Anchor, Text, Truncate}} language="jsx" overflowScroll>
...
<LivePreview scope={{Table, THead, TBody, TFoot, Tr, Th, Td, Card, Text}} language="jsx" overflowScroll>
  {`<Card>
...
<LivePreview scope={{Table, THead, TBody, Tr, Th, Td, Text, Avatar, Box, Stack}} language="jsx" overflowScroll>
  {`<Table>
  <THead>
    <Tr>
      <Th>User</Th>
...
<LivePreview scope={{Table, THead, TBody, TFoot, Tr, Th, Td, Anchor, Truncate}} language="jsx" overflowScroll>
  {`<Table tableLayout="fixed">
  <THead>
    <Tr>
      <Th>Agents</Th>
