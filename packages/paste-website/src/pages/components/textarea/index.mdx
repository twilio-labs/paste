...
A textarea allows users to enter text on multiple lines. It is used with the <Anchor href="/component/label">Label</Anchor> and <Anchor href="/component/help-text">Help Text</Anchor> components.
