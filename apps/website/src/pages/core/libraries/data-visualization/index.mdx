...
<ComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/main/packages/copre/libraries/data-visualization"
...
The hook adds [the following styles](https://github.com/twilio-labs/paste/blob/main/packages/core/libraries/data-visualization/src/usePasteHighchartsTheme.tsx#L42):
