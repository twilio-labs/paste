...
import { Sidebar, SidebarBody, SidebarHeader, SidebarHeaderIconButton, SidebarHeaderLabel, SidebarNavigation, SidebarNavigationItem } from "@twilio-paste/sidebar";
import { useUID } from "@twilio-paste/uid-library";
import * as React from "react";

export const SidebarWithContent: React.FC<React.PropsWithChildren<{ topbarSkipLinkID: string; mainContentSkipLinkID: string }>>
