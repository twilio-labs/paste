...
<ComponentHeader
  ...
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/components-avatar--initials"
...
<p>{props.pageContext.frontmatter.description} The Avatar can be sized in the same way as the <a href="/icons">Paste Icon</a>.</p>
