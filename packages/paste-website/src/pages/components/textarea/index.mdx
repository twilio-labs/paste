...
<ComponentHeader
  ...
  storybookUrl="https://main--5e53448165911c0022e68c74.chromatic.com/?path=/story/components-textarea--textarea-options"
  ...
  <Dont title="Don't" body="Don't use placeholder text for validation instructions." center>
    <Box width="100%" padding="space60">
      ...
      <TextArea
        ...
        id="help_dont"
        name="help_dont"
        placeholder="Please enter: Paste is open source and contributions are welcome."
      />
    </Box>
  </Dont>
</DoDont>
