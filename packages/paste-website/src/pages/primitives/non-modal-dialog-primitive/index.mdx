...
<ComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/master/packages/paste-core/primitives/non-modal-dialog"
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/primitives-non-modal-dialog--simple-non-modal-dialog"
...
We're also using the `as` prop on the `NonModalDialogPrimitive` to creat a styled `Box` with Paste
