...
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| background-color | <ul><li>Error: color-background-error-lightest</li><li>Neutral: color-background-primary-lightest</li><li>Warning: color-background-warning-lightest</li></ul>                                        | No          |
| border-color     | <ul><li>Error: color-border-error-light</li><li>Neutral: color-border-neutral</li><li>Warning: color-border-warning-light</li></ul>                                                                   | No          |
