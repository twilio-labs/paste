...
You may use [the Text primitive](/primitives/text) as a child of Toast, but if you do, be sure to pass `color="colorTextNeutral"` for neutral toasts.
...
You may use [the Text primitive](/primitives/text) as a child of Toast, but if you do, be sure to pass `color="colorTextSuccess"` for success toasts.
...
You may use [the Text primitive](/primitives/text) as a child of Toast, but if you do, be sure to pass `color="colorTextWarningStrong"` for warning toasts.
...
You may use [the Text primitive](/primitives/text) as a child of Toast, but if you do, be sure to pass `color="colorTextError"` for error toasts.
