...
The spinner is an icon component that can be used in situations where you would like to communicate a loading state to the user. It inherits a lot of properties from the [Icon component](/icons/usage-guidelines/).
...
<Callout>
  ...
  <CalloutText>
    ...
    <SiteLink to="/icons/usage-guidelines#accessibility">icon accessibility guidelines</SiteLink>.
  </CalloutText>
</Callout>
...
The Spinner, like any other icon, can be re-colored to meet your needs. Set an `color` in the [same way you would with an icon](/icons/usage-guidelines#adapting-the-icons-color).
