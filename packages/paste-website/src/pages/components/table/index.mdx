...
- Any component can be placed in a Table, but tables should only contain static textual and numeric data, rather
  ...
  selecting rows, or deleting rows), use{' '}
  {" "}
  <SiteLink to="/components/data-grid">Data Grid</SiteLink> instead.
...
<LivePreview
  scope={{ Table, THead, TBody, Tr, Th, Td, Box, Stack, Text }}
  language="jsx"
>
  {`<Table>
  <THead>
  ...
  <TBody>
    <Tr>
      <Td>
        ...
        <Text as="p" color="colorTextWeak" marginLeft="space70">2020-09-17, 16:24:28 PDT</Text>
      </Td>
      <Td>
        <Text as="span" fontFamily="fontFamilyCode">
          SM0yc4mxi6cn4z13bte7qmflc2drc85mlp
