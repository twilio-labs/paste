...
You may use [the Text primitive](/primitives/text) as a child of Alert, but if you do, be sure to pass `color="colorTextNeutral"` for neutral alerts.
...
You may use [the Text primitive](/primitives/text) as a child of Alert, but if you do, be sure to pass `color="colorTextWarningStrong"` for warning alerts.
...
You may use [the Text primitive](/primitives/text) as a child of Alert, but if you do, be sure to pass `color="colorTextError"` for error alerts.
