...
<Image src={DeleteMediumSeverityImage} placeholder="blur" alt="modal with a destrctive button to confirm deletion" />
...
<Image
  src={DeleteHighSeverityImage}
  placeholder="blur"
  alt="modal with an input and a destructive button to confirm deletion"
/>
