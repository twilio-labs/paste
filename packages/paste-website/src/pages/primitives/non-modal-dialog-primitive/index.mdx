...
<ComponentHeader
  ...
  packageName={props.data.allPastePrimitive.edges[0].node.name}
  version={props.data.allPastePrimitive.edges[0].node.version}
  description={props.data.allPastePrimitive.edges[0].node.description}
  status={props.data.allPastePrimitive.edges[0].node.status}
