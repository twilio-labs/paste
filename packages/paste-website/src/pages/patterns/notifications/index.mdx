...
<Callout>
  ...
  <CalloutText>
    <Paragraph>
      While the recommendation is to migrate to Paste Toast components when possible to acknowledge user actions, Flex and SendGrid currently use banners for this purpose.
    </Paragraph>
    <Paragraph>
