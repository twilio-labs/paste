    ...
    <Box display="flex" flexDirection="column" rowGap="space130">
      <Box display="flex">
        ...
        <Box width="100%">
          <Heading as="h5" variant="heading20">
            Configure your AzureSQL database
          </Heading>
          <Paragraph>
            Make sure you’re logging in with a user that has read and write permissions so that we can write to your
            database. If you’re unsure on how to get started, view our documentation on Azure SQL data warehouse.
          </Paragraph>
        </Box>
      </Box>
      <Box display="flex">
      ...
      <Box display="flex">
        ...
        <Box width="100%">
          ...
          <Paragraph marginBottom="space0">Copy and paste these credentials from AzureSQL.</Paragraph>
          <Box marginTop="space80">
            <Form>
              <FormControl>
      ...
      >
        ...
        <Box display="flex" columnGap="space40" alignItems="center">
          ...
          <Button variant="primary" disabled>
            Continue <ArrowForwardIcon decorative />
          </Button>
        </Box>
      </Box>
    </Box>
