...
The Help Text inline error is placed below the field to inform a user of any errors in their value. The error text should replace and repeat the help text.
