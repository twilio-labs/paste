...
<ComponentHeader
  ...
  packageName={props.data.allPasteLayout.edges[0].node.name}
  version={props.data.allPasteLayout.edges[0].node.version}
  description={props.data.allPasteLayout.edges[0].node.description}
  status={props.data.allPasteLayout.edges[0].node.status}
