...
<DoDont>
  <Do
    title="Do"
    body="Include a heading that summarizes the situation. We recommended a maximum of 7 words."
    preview={false}
  />
  <Dont
    title="Don't"
    body="Don't include a long heading providing too many details. If the heading wraps to two or more lines, that may be a sign to be more concise. Don't use a period at the end of a heading."
    preview={false}
  />
</DoDont>
