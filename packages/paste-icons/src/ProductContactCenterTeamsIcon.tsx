...
const ProductContactCenterTeamsIcon = React.forwardRef<HTMLElement, ProductContactCenterTeamsIconProps>(
  ({ as, display, element = "ICON", size, color, title, decorative }, ref) => {
    const titleId = `ProductContactCenterTeamsIcon-${useUID()}`;

    if (!decorative && title == null) {
      throw new Error("[ProductContactCenterTeamsIcon]: Missing a title for non-decorative icon.");
    }
...
ProductContactCenterTeamsIcon.displayName = "ProductContactCenterTeamsIcon";
