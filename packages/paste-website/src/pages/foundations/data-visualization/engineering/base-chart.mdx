export const meta = {
  title: "Data Visualization - Base Chart",
  description: "The base component required to funciton with Paste components.",
  slug: "/foundations/data-visualization/engineering/base-chart",
};
