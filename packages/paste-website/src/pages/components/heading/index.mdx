...
Heading is part of the larger Typography component. The Typography component also includes the Paste [Paragraph](/components/paragraph) component in one easy import. This way you always have everything you need for typographical layouts.
