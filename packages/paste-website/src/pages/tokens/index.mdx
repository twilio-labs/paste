...
import InputTokens from '../../assets/images/tokens/input-tokens-example.png';
import AliasTokens from '../../assets/images/tokens/alias-tokens.png';
...
<ResponsiveImage src={InputTokens} />
...
<Callout variant="neutral" marginY="space70">
  <CalloutHeading as="h3">Need a token that doesn't exist in Paste yet?</CalloutHeading>
  <CalloutText>
...
For more information about how Paste is built and where tokens fit into that hierarchy, read [About Paste](/introduction/about-paste#whats-a-design-system).
...
<ResponsiveImage src={AliasTokens} />
