...
<DoDont>
  <Do title="Do" body="Use sentence case in headings.">
    <Heading>This is sentence case</Heading>
  </Do>
  <Dont title="Don't" body="Don’t use title case.">
    <Heading>This Is Title Case</Heading>
  </Dont>
</DoDont>
