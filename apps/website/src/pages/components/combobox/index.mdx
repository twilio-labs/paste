...
<NormalizeComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/main/packages/core/components/combobox"
...
<LivePreview scope={{Button, Box, CloseIcon, SearchIcon, Combobox, useCombobox}} noInline language="jsx">
  {stateHookCombobox}
</LivePreview>
