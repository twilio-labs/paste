...
const KeyboardKeyGroup = React.forwardRef<HTMLDivElement, KeyboardKeyGroupProps>(
  ({ element = "KEYBOARD_KEY_GROUP", activeKeys, disabled, enablePressStyles, ...props }, ref) => {
    return (
      <KeyboardKeyCombinationContext.Provider value={{ activeKeys, disabled, enablePressStyles }}>
