...
<Callout variant="neutral" marginY="space70">
  ...
  <CalloutText>
    [Readability tools](https://readabilityformulas.com/free-readability-formula-tests.php) can be useful for assessing the "reading age" of long content (more than 150 words), but they can be less helpful for short UI content. Look for a simpler word whenever you can to improve the readability of your content.
</Callout>
...
### Abbreviations
Use common abbreviations if space is limited, like in form headings.
