...
describe('Breadcrumb', () => {
  ...
  describe('Customization', () => {
    describe('HTML attributes', () => {
      describe('Parent element name is defined (Breadcrumb) and element name is defined (BreadcrumbItem)', () => {
        it('should set a element data attribute for Breadcrumb and BreadcrumbItem', () => {
          render(
      ...
      describe('Parent element name is defined (Breadcrumb) and element name is falsy (BreadcrumbItem)', () => {
        it('should set a element data attribute for Breadcrumb and BreadcrumbItem', () => {
          render(
            <Breadcrumb element="TEST_PARENT" data-testid="breadcrumb">
      ...
      describe('Parent element name is not defined (Breadcrumb) and element name is falsy (BreadcrumbItem)', () => {
