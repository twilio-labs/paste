...
<DoDont>
  <Do
    ...
    preview={false}
  />
  <Dont title="Don't" body="Don't use Toasts to communicate dynamically changing content, including progress bars. Use a [Non-Modal Dialog](/primitives/non-modal-dialog-primitive) or [Modal](/components/modal), or show the changing content on the underlying page instead." preview={false} />
