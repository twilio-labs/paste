...
<ComponentHeader
  ...
  storybookUrl="https://main--5e53448165911c0022e68c74.chromatic.com/?path=/story/components-modal--default"
...
If you need to _interrupt_ a user's current task in order to make them perform an action, use an Alert Dialog (not available yet) instead. An Alert Dialog ensures the user acknowledges the information in the dialog but is visually similar to a Modal.
