...
<Callout variant="warning">
  <CalloutTitle>
    This is a proof of concept, and we need your feedback!
  </CalloutTitle>
  <CalloutText>
    etc
  </CalloutText>
  ...
  <Column>
    <Card>
      ...
      <Paragraph marginBottom="space0">
        ...
        , and{' '}
        <Anchor href="../components/paragraph">
          Paragraph
        </Anchor> 
...
- **System-level notifications:** Information that’s not triggered by a user action and is related to system issues.
...
![Toast confirming a password reset email has been sent](../../../assets/images/patterns/notifications-toast@3x.png)

<Callout>
  <CalloutTitle>
    Toasts in Flex and SendGrid?
  </CalloutTitle>
  <CalloutText>
    <Paragraph>
      Flex currently uses global- and specific-level banners to acknowledge user actions, while SendGrid uses only global-level banners. Banners are used in the same way Toasts are.
    </Paragraph>
    <Paragraph>
      Global banners global exist at the top of the page. There’s a limit of 3 per page, and the oldest one is removed when a new one displays. Specific banners exist at the top of the section the action was taken. New banners replace existing ones (i.e., no stacking).
    </Paragraph>
  </CalloutText>
</Callout>
...
- You’re providing multiple links or buttons to help a user continue a flow.
