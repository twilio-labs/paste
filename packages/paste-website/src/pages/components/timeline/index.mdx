...
Use the `onClick` prop on the `TimelineItem` to make the title interactive. This is useful when you want to provide additional context or actions related to the event.
