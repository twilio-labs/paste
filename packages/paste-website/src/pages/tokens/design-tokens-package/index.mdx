export const meta = {
  ...
  description:
    'The Paste Design Tokens package allows you to install design tokens in a variety of different formats (Web, Mobile, etc.)',
...
import packageJson from '@twilio-paste/design-tokens/package.json';
...
See our list of Tokens and their corresponding values in the [Token List](/tokens/) page.

Within themes, we presently have support for:

- [Twilio](https://unpkg.com/browse/@twilio-paste/design-tokens/dist/themes/twilio/)
- [Twilio Dark](https://unpkg.com/browse/@twilio-paste/design-tokens/dist/themes/twilio-dark/)
- [Paste (Default)](https://unpkg.com/browse/@twilio-paste/design-tokens/dist/)
- [Dark](https://unpkg.com/browse/@twilio-paste/design-tokens/dist/themes/dark/)
- [Evergreen](https://unpkg.com/browse/@twilio-paste/design-tokens/dist/themes/evergreen/)
