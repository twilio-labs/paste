...
The Spinner, like any other icon, can be re-colored to meet your needs. Set an `color` in the [same way you would with an icon](/icon-system/#adapting-the-icons-color).
