...
- `src/App.tsx`: creates a `MyApp` component, which wraps all pages. This is where the Paste [`<Theme.Provider>`](/tokens/theme-package#theme-provider) is added which enables any child component to use tokens.
