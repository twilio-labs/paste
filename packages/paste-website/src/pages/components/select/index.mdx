...
If you want to show information that can’t be edited, use a [read-only Input](/input#read-only-input) or consider another way of showing static information.
