...
<Callout variant="neutral" marginY="space70">
  ...
  <CalloutText>
    Learn more about why semantic table markup is important in <Anchor href="https://youtu.be/tlpQ0d2ADNo" showExternal>this demo video by Inclusive Components</Anchor>
...
To determine the order of the remaining columns, conduct usability testing to find out what column ordering works
