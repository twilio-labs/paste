...
const VoiceEnabledIcon: React.FC<VoiceEnabledIconProps> = ({as, display, size, color, title, decorative}) => {
  if (!decorative && title == null) {
    throw new Error('[VoiceEnabledIcon]: Missing a title for non-decorative icon.');
  }
