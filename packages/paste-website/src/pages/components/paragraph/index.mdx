...
```jsx
import {Paragraph} from '@twilio-paste/paragraph';
// or import {Paragraph} from '@twilio-paste/core';

<Paragraph>
  Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur praesentium voluptate facere suscipit maiores
  vitae explicabo error ea? Quisquam, nisi excepturi aut esse non iste dolorum dicta. Tempore, doloribus voluptate!
</Paragraph>;
```
