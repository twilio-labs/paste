...
<ComponentHeader
  ...
  packageName={props.data.allPasteComponent.edges[0].node.name}
  version={props.data.allPasteComponent.edges[0].node.version}
  description={props.data.allPasteComponent.edges[0].node.description}
  status={props.data.allPasteComponent.edges[0].node.status}
  figmaStatus={props.data.allAirtable.edges[0].node.data.Figma}
  designCommitteeStatus={props.data.allAirtable.edges[0].node.data.Design_committee_review}
  engineerCommitteeStatus={props.data.allAirtable.edges[0].node.data.Engineer_committee_review}
/>
...
Tables fill 100% width of the space of their containing element. Use [Layout components](/layout) to control the size and
