...
Use a heading that succinctly summarizes the situation. We recommend a maximum of 7 words.

Use an illustration that's directly related to the message you're communicating.
...
[Learn more about requesting a new illustration](/illustrations#request-new-illustrations).
