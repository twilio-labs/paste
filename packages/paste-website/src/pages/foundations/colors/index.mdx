...
import UseOfColor from '../../../assets/images/foundations/colors/use-of-color-example.png';
import InteractingStates from '../../../assets/images/foundations/colors/interacting-states.png';
...
<Image src={TokensDiagram} placeholder="blur" />
...
<Image src={UseOfColor} placeholder="blur" />
...
<Image src={InteractingStates} placeholder="blur" />

<InteractingStatesImgCaption />

<Callout variant="neutral" marginY="space70">
  <CalloutHeading as="h4">Still need more guidance?</CalloutHeading>
  <CalloutText>
