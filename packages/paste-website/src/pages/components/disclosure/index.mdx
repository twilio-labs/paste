...
<NormalizedComponentHeader
  ...
  storybookUrl="/?path=/story/components-disclosure--"
  data={props.data}
/>
...
Disclosure headers should be short, no more than 1 line, and priortize the user goal. Use sentence case for the headers.
