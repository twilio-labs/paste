...
Submit a <a href="http://tiny.cc/csrf2020">Content Support Request</a> to receive asynchronous or 121 support from Caroline, Sr UX Writer. 
...
Kicking off a content-heavy project or feature? Submit a <a href="http://tiny.cc/csrf2020">Content Support Request</a> for a 30-min 121 to discuss it. 
...
### Slack
Reach out to Caroline on Slack if 
- you're not sure what kind of support you need.
- you have an unavoidable, urgent request. (There's no guarantee of support for last-minute requests.)
...
**This section is in development.** You can use these questions either as prompts when you're self-editing or as a framework for review.
