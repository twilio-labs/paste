...
Additionally, each Paste container component (_e.g._, Card, Modal) symbol in Sketch has an invisible grid symbol named “📐 Grid” that you can override with visible grid symbols.
