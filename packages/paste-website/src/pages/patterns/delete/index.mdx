---
title: Delete
description: Use these patterns to allow a user to destroy an object.
...
import {​
  Button,
  Modal, ModalBody, ModalFooter, ModalFooterActions, ModalHeader, ModalHeading,
...
For more information, check out our [notification and feedback patterns](/patterns/notifications).
