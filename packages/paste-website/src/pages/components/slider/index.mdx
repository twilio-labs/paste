...
Use a custom step Slider when the default step doesn't fit your use case.
...
<DoDont>
  <Do title="Do" body="Use a Slider for mid-sized, defined ranges, usually 1–100">
    <Label>Opacity</Label>
    <Slider />
  </Do>
  <Dont title="Don't" body="Don’t use a Slider for very large or very small ranges.">
...
const Component = () => {
  ...
  // const helpTextId = useUID(); // optional if you have Help Text
