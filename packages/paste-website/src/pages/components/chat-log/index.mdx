...
To convey an error related to other actions taken in the Chat Log, like a file upload validation error, use an [Alert](/components/alert) at the top of the individual chat window.
