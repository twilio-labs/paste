...
*Avoid* using abbreviations in body copy. It might look "neater" but it can increase cognitive load and reduce comprehension.
...
- Only **bold the most important information the user needs to retain** and deploy it only if user testing flags a need. 
- Consider if putting an important sentence on a new line will do a better job of making it stand out than making it bold. 

##### Italics
**Avoid** using italic type wherever possible. 
...
#### Dates
**Do** use American formatting as your default way to represent dates.
- *MM/DD/YYYY* 
- *Day, Month DD, YYYY* e.g., Sunday, May 17, 2020
...
**Do** use both words and numerals to represent large numbers. 
- *Up to 40k emails*
- *More than $1.5B*
...
**Do** use commas in number four or more digits
- *1,365 messages sent*
