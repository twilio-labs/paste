...
export const pageQuery = graphql`
  {
    allPasteComponent(filter: {name: {eq: "@twilio-paste/grid"}}) {
      edges {
        node {
          name
          description
    ...
    mdx(fields: {slug: {eq: "/components/grid/"}}) {
      fileAbsolutePath
      frontmatter {
        slug
        title
...
<NormalizeComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/main/packages/core/components/grid"
