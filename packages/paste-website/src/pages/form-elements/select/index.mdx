...
import {FormLabel, FormHelpText, FormInput, Select, Option, OptionGroup, CheckboxGroup, Checkbox} from '@twilio-paste/form';
...
<UnorderedList>
  ...
  <ListItem>
    Users will be selecting from a list of 4-10 options, or a sorted list of highly familiar options (<em>e.g.</em>, alphabetical
...
<UnorderedList>
  ...
  <ListItem>You need to show more than text in an option (<em>e.g.</em>, text paired with an icon).</ListItem>
  <ListItem>You need placeholder text in the field to show an example option, rather than a pre-selected option.</ListItem>
  <ListItem>
    Users would benefit from typeahead functionality (<em>e.g.</em>, autocomplete, search). For example, typeahead may be useful
    when users need to select from a list of more than 10 options.
  </ListItem>
...
<LivePreview scope={{Select, Option, FormLabel}} language="jsx">
  {`<>
  <FormLabel htmlFor="twilio_product">Select a Product</FormLabel>
  <Select id="twilio_product" htmlFor="product">
...
<LivePreview scope={{Select, Option, FormHelpText, FormLabel}} language="jsx">
  ...
  <FormHelpText variant="default" id="select_product">Please choose a Twilio product.</FormHelpText>
</>`}
</LivePreview>
...
<LivePreview scope={{Select, Option, OptionGroup, FormHelpText, FormLabel}} language="jsx">
  ...
  <FormHelpText variant="default" id="option_group_demo_help_text">Select a product to learn more.</FormHelpText>
</>`}
</LivePreview>
...
<LivePreview scope={{Select, Option, FormHelpText, FormLabel}} language="jsx">
  {`<>
  <FormLabel htmlFor="mutliple_options_demo" required>Phone number capabilities</FormLabel>
  <Select
    id="mutliple_options_demo"
    htmlFor="mutliple_options_demo"
    multiple
    size="2"
  >
  ...
  <FormHelpText variant="default" id="mutliple_options_demo_help_text">Select your desired number capabilities.</FormHelpText>
</>`}
</LivePreview>
...
<LivePreview scope={{Select, Option, FormHelpText, FormLabel}} language="jsx">
  ...
  <FormHelpText variant="error" id="console_team_help_text">The number you have selected is not configured for emergency calling.</FormHelpText>
</>`}
</LivePreview>
...
<LivePreview scope={{Select, Option, FormHelpText, FormLabel}} language="jsx">
  {`<>
  <FormLabel htmlFor="disabled_options_demo">Phone number capabilities</FormLabel>
  <Select
  ...
  <FormHelpText variant="default" id="disabled_options_demo_help_text">Some options in this select are disabled.</FormHelpText>
</>`}
</LivePreview>
...
<LivePreview scope={{Select, Option, FormHelpText, FormLabel}} language="jsx">
  ...
  <FormHelpText variant="default" id="console_team_help_text">This select is currently disabled.</FormHelpText>
</>`}
</LivePreview>
...
Keep option text concise and simple. Option text will truncate when it’s longer than the width of the container. If choosing options require more explanation, consider using a checkbox instead and add help text for each option, or give more explanation through help text.
...
<DoDont>
  ...
  >
      ...
      <Select id="option_text_dont" name="option_text_dont" onChange="">
        ...
        <Option value="test-two">{'https://test.twilio.com/welcome/voice/long-test/too-long/text-continuing/still-continuing'}</Option>
      </Select>
      </Box>
  </Dont>
</DoDont>
...
<DoDont>
  <Do
    center
    title="Do"
    body="Keep help text and error text concise and simple."
  >
    <Box width="100%" padding="space60">
      ...
      <FormHelpText variant="default" id="help_text_length_do">HTTP action for voice webhook.</FormHelpText>
    </Box>
  </Do>
  <Dont center title="Don't" body="Don’t use more than 2 sentences in help text or error text.">
    <Box width="100%" padding="space60">
      ...
      <FormHelpText variant="default" id="help_text_length_dont">HTTP action for voice webook. This will be used to manage an incoming call. Please also configure your fallback url and method in case the primary handler fails.</FormHelpText>
    </Box>
  </Dont>
</DoDont>
...
<DoDont>
  ...
  >
    <Box width="100%" padding="space60">
      ...
      <FormHelpText variant="default" id="disabled_do_help_text">Please sign in again to change the HTTP method.</FormHelpText>
    </Box>
  </Do>
  <Dont
    center
...
<DoDont>
  ...
  <Dont
    center
    title="Don't"
    body="When possible, avoid allowing multiple selection on a select component."
  >
    <Box width="100%" padding="space60">
