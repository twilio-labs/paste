...
| [Components](/components)       | A suite of common UI components (in Sketch and React) that can be composed into any web based user experience. They follow the WCAG 2.1 AA standard and the W3C ARIA authoring practices to ensure the best accessibility practices are baked into them. They are available to be installed via NPM or Abstract for anyone to use.                                                                                         |
...
| [Layouts](/layout)              | Ways to responsively space, align, and position your UI in a variety of ways.                                                                                                                                                                                                                                                                                                                                              |
| Compositions (Coming soon)      | Common, repeatable, and extensible Twilio UX patterns that you can use to solve product and UI problems.                                                                                                                                                                                                                                                                                                                   |
...
By providing all teams with a shared set of composable tokens, components, and patterns to pull from, Paste helps teams design and build faster, and makes future UI upgrades simple. This allows us to keep our product bar high without sacrificing speed. This also allows for efficient reuse of features and designs across a customer’s communication journey by enabling UI reuse across different products and workflows.

### Instill trust and confidence

Paste is designed to mature our UI interfaces and improve reuse, resiliency, and upgrades at scale. By using Paste, we can create interfaces that inspire customer trust and confidence in our product teams to be able to ship updates to our product UIs with zero negative impact to the end customer. Our technology choices mean our components are encapsulated but extensible, enabling versioned design updates.
...
Paste takes a lot of its inspiration from the fantastic folks that have done this before us. We seek diverse opinions in designing our solutions for our customers. We can&rsquo;t build Paste without the ideas proposed by:
...
- Deigo Haz for [Reakit ](https://reakit.io/)
