...
<ComponentHeader
  ...
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/components-modal--default"
  abstractUrl="https://share.goabstract.com/57f1068b-7265-4102-84fa-0b2bf70214e2"
...
If you need to *interrupt* a user's current task in order to make them perform an action, use an [Alert Dialog](/components/alert-dialog) instead. An Alert Dialog ensures the user acknowledges the information in the dialog but is visually similar to a Modal.
...
<Callout>
  ...
  <CalloutText>
    Be sure to assign the <inlineCode>aria-labelledby</inlineCode> property on the modal container to the id if the modal heading.
  </CalloutText>
</Callout>
