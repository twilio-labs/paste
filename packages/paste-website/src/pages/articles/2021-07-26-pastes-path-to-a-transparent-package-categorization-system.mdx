...
slug: /articles/2021-07-26-pastes-path-to-a-transparent-package-categorization-system/
date: 2021-07-26
author: Nora Krantz
...
export const pageQuery = graphql`
  {
    mdx(fields: {slug: {eq: "/articles/2021-07-26-pastes-path-to-a-transparent-package-categorization-system/"}}) {
      fileAbsolutePath
      frontmatter {
        slug
        title
