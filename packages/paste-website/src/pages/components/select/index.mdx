...
A select allows users to select an option from a list in a form field. It is used with the <Anchor href="/component/label">Label</Anchor> and <Anchor href="/component/help-text">Help Text</Anchor> components.
