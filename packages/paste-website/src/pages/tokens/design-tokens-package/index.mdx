...
<ComponentHeader
  ...
  packageName={props.data.allPasteDesignTokensPackage.edges[0].node.name}
  version={props.data.allPasteDesignTokensPackage.edges[0].node.version}
  description={props.data.allPasteDesignTokensPackage.edges[0].node.description}
/>
