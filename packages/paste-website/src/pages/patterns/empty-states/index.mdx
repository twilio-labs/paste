...
Go to the [Sizing & responsiveness section](/patterns/empty-states#sizing-and-responsiveness) for more details.

We recommend using a fixed width of `$size-20`.

The illustration must be directly related to the message you’re communicating. Read more about [which illustrations to use for each use case](/patterns/empty-states#content-examples-by-use-case).
