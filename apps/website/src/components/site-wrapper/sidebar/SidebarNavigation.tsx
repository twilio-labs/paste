...
const SidebarNavigation: React.FC = () => {
  ...
  const {allPasteComponent, allPastePrimitive, allPastePattern} = getNormalizedNavigationData(data);

  const allComponentSidebarItems = [...allPasteComponent, {name: 'Icon', slug: 'icons'}];
