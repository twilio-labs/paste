  ...
  packageStatus={[
    {
      node: {
        data: {
          ...
          Design_committee_review: 'yes',
          Engineer_committee_review: 'yes',
          Code: 'yes',
          status: 'production',
        },
      },
...
To do this, [install the Core package](/getting-started/manual-installation/#paste-packages) and use unbarreled imports to individually import
