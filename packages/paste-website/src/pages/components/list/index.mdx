...
<Callout variant="warning" marginY="space60">
  <CalloutHeading as="h3">Alignment considerations</CalloutHeading>
  <CalloutText>
    If you're not utilizing the <InlineCode>OrderedDisplayListHeading</InlineCode>
    component, please note that only the <InlineCode>heading50</InlineCode> and
    <InlineCode>heading60</InlineCode> variants are automatically aligned with their
    corresponding list item numbers.
  </CalloutText>
</Callout>
