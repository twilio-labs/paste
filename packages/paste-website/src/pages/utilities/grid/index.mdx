...
Use the `span` prop to allow content to span multiple columns. `Span` defines how many columns you want the width of your content to take up. The value of `span` becomes the
...
In our example we're setting one column to equal 8 of the 12 columns, and the other to be 4 of the 12 columns.
...
<DoDont>
  ...
  <Dont title="Don't" body="Don’t use Grid with only one column of full-width content. This causes unnecessary elements. Box is what you’re looking for here.">
    <Box padding="space60">
      <Grid gutter="space30">
        <Column>
          <Card>
...
Add [Grid symbols from the “Paste components” project](https://share.goabstract.com/3e7528f5-7981-421c-9308-e06d2f341c70) to your own artboards to help you align content.
