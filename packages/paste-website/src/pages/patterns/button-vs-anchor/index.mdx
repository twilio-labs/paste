...
import ButtonPrimaryActionImage from '../../../assets/images/patterns/button-primary-action.png';
import ButtonMultipleActionsImage from '../../../assets/images/patterns/button-multiple-actions.png';
import ButtonAnchorLikeButtonsImage from '../../../assets/images/patterns/button-anchor-like-buttons.png';
import ButtonCardExternalAnchorImage from '../../../assets/images/patterns/button-card-external-anchor.png';
...
export const getStaticProps = async () => {
  ...
  const feature = await getFeature('Button vs Anchor');
  return {
    props: {
      data: {
        ...feature,
...
<ResponsiveImage src={ButtonPrimaryActionImage} alt="table with a primary create new action button" />
...
<ResponsiveImage src={ButtonMultipleActionsImage} alt="table with multiple action buttons" />

### Link-style button (tertiary)

<Callout variant="warning" marginY="space70">
  <CalloutHeading as="h4">This is not a variant we recommend you use often.</CalloutHeading>
  <CalloutText>
...
<ResponsiveImage src={ButtonAnchorLikeButtonsImage} alt="layout with anchors and anchors that look like buttons" />
...
<ResponsiveImage src={ButtonCardExternalAnchorImage} alt="card layout with internal and external anchors" />
