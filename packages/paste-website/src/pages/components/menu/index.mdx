...
They can be given a prefix icon; please only use icons in a [decorative manner](https://paste.twilio.design/icon-system#specify-if-an-icon-is-decorative)
...
| color          | color-text-weaker (disabled) or color-text (regular) | No          |
...
| padding-top    | space-20                                  | No          |
| padding-bottom | space-20                                  | No          |
| padding-left   | space-50 (has icon) or space-70 (regular) | No          |
| padding-right  | space-70                                  | No          |
| color          | color-text                                | No          |
