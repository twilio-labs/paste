...
<Stack orientation="vertical" spacing="space140">
  <Disclosure visible>
    ...
    <DisclosureContent>
      <Paragraph>
        We support the latest and latest minus one versions of all modern browsers on the market today. Most notible
        mentions include:
      </Paragraph>
      <UnorderedList>
    ...
    <DisclosureContent>
      ...
      <UnorderedList>
        <ListItem>
          ...
          independent teams and confidence in your deploys. This particularly applies to a number of Twilio products
  ...
  <Disclosure>
    <DisclosureHeading as="h3" variant="heading30">
      Why does Paste use React-uid to generate ids? Why don't you use static ids?
    </DisclosureHeading>
    <DisclosureContent>
      <Paragraph>
        ID references in a webpage must be unique for them to work correctly, especially when supporting assistive
      ...
      <Paragraph>
        To guarantee that every id in a webpage is unique, regardless of what was loaded on the page and in what order,
        we use react-uid to generate ids for us.
      </Paragraph>
    </DisclosureContent>
  </Disclosure>
  <Disclosure>
    ...
    <DisclosureContent>
      <Paragraph>We recommend using data attributes for your test indentifiers.</Paragraph>
      <Paragraph>
  ...
  <Disclosure>
    ...
    <DisclosureContent>
      ...
      <Paragraph>
        For the Console theme, due to licensing restictions only web properties under certain domains are allowed to
