...
<ResponsiveImage src={typography2} alt="examples of Paste's various font weight tokens" />
...
<ResponsiveImage src={typography3} alt="examples of Paste's various font weight tokens" />
<Box display="flex" justifyContent="center" marginBottom="space40">
  <Text fontWeight="fontWeightBold" fontSize="fontSize40">
    Do
  </Text>
</Box>
<ResponsiveImage src={typography4} alt="examples of Paste's various font weight tokens" />
<Box display="flex" justifyContent="center" marginBottom="space40">
  <Text fontWeight="fontWeightBold" fontSize="fontSize40">
    Don't
  </Text>
</Box>
<ResponsiveImage src={typography5} alt="examples of Paste's various font weight tokens" />
...
<ResponsiveImage src={typography6} alt="examples of Paste's various font weight tokens" />
...
<ResponsiveImage src={typography7} alt="examples of Paste's various font weight tokens" />
...
<ResponsiveImage src={typography8} alt="examples of Paste's various font weight tokens" />
...
<ResponsiveImage src={typography13} alt="examples of Paste's various font weight tokens" />
...
<ResponsiveImage src={typography14} alt="examples of Paste's various font weight tokens" />
<ResponsiveImage src={typography15} alt="examples of Paste's various font weight tokens" />
