...
might be included to make the website more visually attractive."*<sup><Anchor href="https://www.w3.org/WAI/tutorials/images/decorative/">w3.org</Anchor></sup> 

Our icons require that the developer says if an icon is decorative by [providing the required property](/icon-system#making-an-icon-decorative-or-informative).
...
<Callout>
  <CalloutText>
    TODO: we should provide a better icon for this example when we have one. 
  </CalloutText>
</Callout>
