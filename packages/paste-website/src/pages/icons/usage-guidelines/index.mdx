...
<Callout>
  ...
  <CalloutText>
    Check <Anchor href="https://streamlineicons.com/">Streamline</Anchor> and contribute
...
Our icons require the developer define whether an icon is decorative by [providing the required property](/icons/usage-guidelines#making-an-icon-decorative-or-informative).
...
performance benefits](/icons/usage-guidelines#why-react-components). As our icon set grows to contain over 100 icons, we don't
