...
### [Elevation foundations](/foundations/elevation)
...
### [Keyboard Key](/components-keyboard-key) component
...
<Box marginBottom="space60" display="flex" justifyContent="center">
    <Box
      ...
      height="100%"
      src={KeyboardKey}
      alt="Keyboard Key component example"
      style={{ objectFit: "contain" }}
    />
</Box>
...
### [Blockquote](/components/blockquote) and [Example Text](/components/example-text) components
...
<Box marginBottom="space60" display="flex" justifyContent="center">
    <Box
      ...
      height="100%"
      src={Blockquote}
      alt="Blockquote and Example Text components"
      style={{ objectFit: "contain" }}
    />
</Box>
...
### [Typewriter animations in AI Chat Log](/components/ai-chat-log#animating)
