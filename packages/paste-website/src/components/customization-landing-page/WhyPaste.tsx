...
const WhyPasteTopAngle: React.FC<React.PropsWithChildren<unknown>> = () => {
...
const WhyPasteBottomAngle: React.FC<React.PropsWithChildren<unknown>> = () => {
...
export const WhyPaste: React.FC<React.PropsWithChildren<unknown>> = () => {
  return (
    <LandingPageSection
