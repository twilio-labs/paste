...
export const pageQuery = graphql`
  {
    allPasteComponent(filter: {name: {eq: "@twilio-paste/flex"}}) {
      edges {
        node {
          name
          description
    ...
    mdx(fields: {slug: {eq: "/components/flex/"}}) {
      fileAbsolutePath
      frontmatter {
        slug
        title
...
<NormalizeComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/main/packages/core/components/flex"
