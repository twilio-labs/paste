...
<GenericHeader
  ...
  storybookUrl="https://paste-storybook.twilio.design/?path=/story/libraries-code-editor-editor--"
...
See more examples on the [storybook](https://paste-storybook.twilio.design/?path=/story/libraries-code-editor-editor--).
