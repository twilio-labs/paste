...
<NormalizedComponentHeader
  ...
  storybookUrl="/?path=/story/components-separator--"
  data={props.data}
/>
...
`horizontalSpacing` and `verticalSpacing` are responsive props. You can provide them an array of spacing values to change the spacing based on the screen sizes supported by your [theme](/theme/#theme-provider).
