...
import {PrimaryColorExample, DestructiveColorExample} from '../../../component-examples/ColorsFoundationExamples';
...
When choosing colors, they should be able to be seen by all kinds of users, including those with low vision. Learn more about inclusive design via [our Inclusive Design Guide](/accessibility).
