...
WIP: making our own version of https://react-layouts.com/ to demo here.
...
The Box component permits every token under the following properties:

backgroundColor
Border (color, style, radius, width)
Sizing (width, maxWidth, height, maxHeight)
Spacing (margin, padding)

Via a number of shorthand props.
...
| ----------------- | -------------------------------------- | ------------------------------------------------ | ------- |
| as?               | string                                 | The HTML tag to replace the default `<div>` tag. | 'div'   |
| backgroundColor?  | keyof ThemeShape['backgroundColors']   | One of our token background colors               |         |
| borderColor?      | keyof ThemeShape['borderColors']       | One of our token border colors                   |         |
| borderBottomColor | keyof ThemeShape['borderColors']       | One of our token border colors                   |         |
| overflow?         | string                                 | CSS overflow property                            |         |
| display?          | `ResponsiveValue<CSS.DisplayProperty>` | The CSS display property                         | 'block' |
