...
const EmojiIcon = React.forwardRef<HTMLElement, EmojiIconProps>(
  ({ as, display, element = 'ICON', size, color, title, decorative }, ref) => {
    const titleId = `EmojiIcon-${useUID()}`;

    if (!decorative && title == null) {
      throw new Error('[EmojiIcon]: Missing a title for non-decorative icon.');
    }
