...
This can be useful when information or relationships between UI controls are only communicated _visually_. By being able to visually hide some content you are able to provide clarifying information to non-sighted users and maintain the visual design.
