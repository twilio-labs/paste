...
>
  ...
  <SidebarBody>
    <SidebarNavigation aria-label="main" sidebarNavigationSkipLinkID="nav" hierarchical hideItemsOnCollapse>
...
- Set a value for `sidebarNavigationSkipLinkID` to be used with Sidebar skip link functionality. The ID must be a unique string not used elsewhere in the application.
...
<StoryPreview
  ...
  <SidebarBody>
    <SidebarNavigation aria-label="main navigation" sidebarNavigationSkipLinkID={sidebarNavigationSkipLinkID}>
      <SidebarNavigationItem
        href=""
        selected
        icon={<ProductContactCenterAdminIcon decorative={false} title="Admin" />}
...
>
  ...
  <SidebarBody>
    <SidebarNavigation aria-label={id} hierarchical hideItemsOnCollapse sidebarNavigationSkipLinkID={sidebarNavigationSkipLinkID}>
      <SidebarNavigationItem href="https://google.com" icon={<ProductHomeIcon decorative />}>
        Home
      </SidebarNavigationItem>
      <SidebarNavigationDisclosure>
...
| `aria-label`                  | `string`          | Accessible name for the navigation element, useful for application navigation using assistive technology |                        |
...
| `sidebarNavigationSkipLinkID` | `string`          | Unique ID used to identify the Sidebar Navigation element for Skip Link functionality.                   |                        |
