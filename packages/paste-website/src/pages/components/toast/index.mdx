...
| Prop   | Type                        | Description                                             | Default |
| ------ | --------------------------- | ------------------------------------------------------- | ------- |
| toasts | `UseToasterToast[]`         | Array of Toasts to render inside the toaster. See below | null    |
| push?  | `(UseToasterToast) => void` | Method used to push a Toast to the Toast stack          | null    |
