...
<ComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/master/packages/paste-core/primitives/box"
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/primitives-box--default"
...
The Box component takes original inspiration from [RebassJs](https://rebassjs.org/) and is powered by [Styled System](https://styled-system.com/). The psuedo class functionality was inspired by and mimics [Chakra UI](https://chakra-ui.com/).
