...
<NormalizedComponentHeader
  ...
  storybookUrl="/?path=/story/layout-grid--"
  data={props.data}
/>
...
<Callout variant="neutral" marginY="space70">
  <CalloutHeading as="h4" variant="heading40">
...
<Callout variant="neutral" marginY="space70">
  <CalloutHeading as="h3">Gutter sizing</CalloutHeading>
  <CalloutText>
    ...
    <Box padding="space60">
      <Grid gutter="space30">
        <Column>
          <Card>
            <Paragraph>
              Unnecessary HTML elements. Use <SiteLink href="/primitives/box">Box</SiteLink> instead.
            </Paragraph>
          </Card>
        </Column>
      </Grid>
