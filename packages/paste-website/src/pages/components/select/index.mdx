...
A select allows users to select an option from a list in a form field. It is used with the <Anchor href="/components/label">Label</Anchor> and <Anchor href="/components/help-text">Help Text</Anchor> components.
...
<DoDont>
  ...
  >
    <Box width="100%" padding="space60">
      ...
      <HelpText variant="default">Please sign in again to change the HTTP method.</HelpText>
    </Box>
  </Do>
  <Dont
    center
...
<HelpText variant="default">Please select one</HelpText>
```
