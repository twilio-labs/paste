...
We strongly advise that you include the [Highcharts Accessibility module](/foundations/data-visualization#adding-highcharts-accessibility-module) to ensure that your charts are accessible to all UserMessage.
...
Highcharts by deafult does no include it's [accessability](https://www.highcharts.com/docs/accessibility/accessibility-module) module. Every Highcarts license includes the Accessibility module which adheres to the WCAG 2.1 standard. You will not need to do anything other than add the module to Highcarts to gain enhanced keyboard navigation and screen reader funcitonality.
...
</contentwrapper>applyPasteHighchartsModules,
