...
<NormalizedComponentHeader
  ...
  storybookUrl="/?path=/story/primitives-menu--"
  data={props.data}
/>
...
<Callout variant="warning" marginY="space70">
  <CalloutHeading as="h3">Before you roll your own menus...</CalloutHeading>
  <CalloutText>
...
<Callout variant="neutral" marginY="space70">
  <CalloutHeading as="h3">We've chosen not to include MenuBar for now</CalloutHeading>
  <CalloutText>
    ...
    <Box display="flex" justifyContent="center">
      <Image src={MenuBar} placeholder="blur" style={{height: '100%', maxWidth: '100%'}} />
    </Box>
  </CalloutText>
</Callout>
