...
----------------------------------------------------------------------------------- | -----------------------------------------------------------------------------------------------------------------------------------
[Radio Button Group](/components/radio-button-group)                                | Use it when you have a list of up to 6 fixed items, and users need to select only one at a time.
[Singleselect Combobox](/components/combobox)                                      | Use it when you have more than 6 options in a fixed list and users need to select only one at a time.
...
<DoDont>
  <Do title="Do" preview={false} body="Consider the performance implications of loading conditional filters." />
  <Dont
    title="Don't"
    preview={false}
    body="Don’t use conditional filtering for essential filter criteria."
  />
</DoDont>
<DoDont>
  <Do title="Do" preview={false} body="Only one conditional filter should be expanded at a time." />
</DoDont>
