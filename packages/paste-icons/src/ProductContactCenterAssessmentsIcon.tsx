      ...
      <IconWrapper as={as} display={display} element={element} size={size} color={color} ref={ref}>
        ...
        >
          ...
          <path
            fill="currentColor"
            fillRule="evenodd"
            d="M9.5 3a2 2 0 00-2 2 .5.5 0 01-.5.5H4.5A.5.5 0 004 6v10.5a.5.5 0 00.5.5h5a.5.5 0 010 1h-5A1.5 1.5 0 013 16.5V6a1.5 1.5 0 011.5-1.5h2.042a3 3 0 015.916 0H14.5A1.5 1.5 0 0116 6v1.5a.5.5 0 01-1 0V6a.5.5 0 00-.5-.5H12a.5.5 0 01-.5-.5 2 2 0 00-.586-1.414M9.5 3a2 2 0 011.414.586z"
            clipRule="evenodd"
          />
          <path
            fill="currentColor"
          ...
          <path
            fill="currentColor"
            fillRule="evenodd"
            d="M16.58 11.937a.5.5 0 01.1.7l-1.936 2.582c-.086.114-.196.21-.322.278m2.159-3.56a.5.5 0 00-.7.1zm-.7.1l-1.937 2.582zm-1.937 2.582l-1-1a.5.5 0 00-.708.707l1 1a1.002 1.002 0 001.186.171"
            clipRule="evenodd"
          />
          <path
            fill="currentColor"
