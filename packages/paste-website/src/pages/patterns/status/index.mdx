...
For convience and consistency, we have created a [`StatusBadge`](/components/status-badge) component that can be used to compose a status icon with a text label.
