...
<Callout variant="warning">
  ...
  <CalloutText>
    If you're planning on using Breadcrumbs in a Console product, please reach out to the Console team first (#help-console-beta). Breadcrumbs will eventually be provided through Console navigation.
  </CalloutText>
</Callout>
...
<DoDont>
  ...
  <Dont title="Don't" body="Add a trailing slash" center>
    <Breadcrumb>
      <BreadcrumbItem href="#">Phone Numbers</BreadcrumbItem>
      <BreadcrumbItem href="#">Buy new number</BreadcrumbItem>
      <BreadcrumbItem />
