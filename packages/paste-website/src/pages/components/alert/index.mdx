...
Use a warning Alert to help a user avoid an issue. If the user can take an immediate action to avoid the issue, provide a way to do it. A Warning Alert should provide explain the possible issue, what to do, and what happens if they don't.
...
- Calloutscommunicate information particular to a section of a page, or information that applies to a whole page.
