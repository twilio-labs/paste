---
title: Console
description: Guidelines for designing and building Console experiences.
...
export const pageQuery = graphql`
  {
    mdx(frontmatter: {slug: {eq: "/experiences/console/"}}) {
      fileAbsolutePath
      frontmatter {
        slug
        title
...
<Box display={['block', 'flex']} columnGap="space40" alignItems="stretch">
  <Box width={['100%', '50%']} marginBottom="space20">
    <Card>
      <Paragraph>
        <strong>Develop</strong>
      </Paragraph>
      <Paragraph>
        The customer is getting started, learning about how Twilio works, testing out Twilio product(s), prototyping a
        POC, buying and configuring numbers, setting up services, building their application, and integrating it into
        their own system.
      </Paragraph>
      <Paragraph>Primary Personas: Developers, Business and Product leaders</Paragraph>
    </Card>
  </Box>
  <Box width={['100%', '50%']} marginBottom="space20">
    <Card>
      ...
      <Paragraph>
        The customer has "launched" their application into production and needs to monitor it's activity, coming back to
        Console to troubleshoot, debug, review logs and insights.
      </Paragraph>
      <Paragraph>Primary Personas: Customer support, Developers, and Product Managers</Paragraph>
    </Card>
  </Box>
</Box>
<br />
...
![](../../../assets/images/experiences/console/develop-or-monitor.png)

<ImageCaption>
  A diagram of the Console experience, showing the steps from left to right as Evaluate, Develop, Monitor, and Grow. An
  arrow points from Explore, a subsection below Grow, to Evaluate (Existing user), a subsection below Develop, an
...
**Primary Personas:** Developers, Builders, Technical support managers <br />
Jobs to be done: Troubleshooting, debugging

**Secondary Personas:** Business managers, Billing administrators <br />
...
**Primary Personas:** Product owners, business manager<br />
...
[![](../../../assets/images/experiences/console/service-list-service-detail.png)](/static/d7a584b885322d148f87e53dee05dfca/551cd/service-list-service-detail.png)

<ImageCaption>
  When you choose a service from a list, it opens up a page focused on that service's details.
</ImageCaption>
...
**Primary personas:** Billing managers, IT Admins, Customer support <br />
...
![](../../../assets/images/experiences/console/breadcrumb-example.png)

<ImageCaption>A screenshot of breadcrumbs being used on a Console page</ImageCaption>
...
![](../../../assets/images/experiences/console/beta-tag.png)

<ImageCaption>
  A beta tag being used in the header of a Console page to identify and describe a beta-stage product.
</ImageCaption>
...
Product description should be between 35-60 characters to fit ([see pre-launch checklist](#console-product-pre-launch-checklist)).
...
![](../../../assets/images/experiences/console/product-explorer.png)

<ImageCaption>A screenshot of the Product Explorer page showing a catalog of Twilio products by category</ImageCaption>

## Search ("Jump to...")

The "jump to" bar in the Console masthead area allows users to quickly jump to a specific page in the Console.
The results will automatically populate with your published product pages.

It is recommended that you also add keywords to help with findability of your product pages by
[updating the search JSON](https://code.hq.twilio.com/twilio/console-navigation-backend/blob/main/json/consoleSearch.json)
and creating a PR in the repository.
...
![](../../../assets/images/experiences/console/regional-1.png)

<ImageCaption>
  Example of a product with a pinned region. Voice has multiple regions and the US is pinned as the default.
</ImageCaption>
...
![](../../../assets/images/experiences/console/regional-2.png)

<ImageCaption>Example of popover explaining a product is regional</ImageCaption>
...
![](../../../assets/images/experiences/console/regional-3.png)

<ImageCaption>Example of region headers in both Develop and Monitor</ImageCaption>
...
![](../../../assets/images/experiences/console/regional-4.png)

<ImageCaption>Example of a shortened region name shown for a product</ImageCaption>
...
![](../../../assets/images/experiences/console/regional-5.png)

<ImageCaption>Example of a regional badge and popover to a product's region</ImageCaption>
