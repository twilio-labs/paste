...
### Select and default values
To be consistent with React's documentation on best practices for native select elements, the <inlineCode>selected</inlineCode> attribute is not allowed in the API. 
...
<LivePreview scope={{Select, Option, FormLabel, FormHelpText, Box}} language="jsx">
  ...
  <Box marginBottom="space80">
    <FormLabel htmlFor="first_name">First NameConsole team</FormLabel>
  ...
  <Box>
    <FormLabel htmlFor="last_name">Last NameConsole team</FormLabel>
        <Select id="test-select">
        <Option>Option 1</Option>
        <Option>Option 2</Option>
    </Select>
