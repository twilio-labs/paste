...
[SF Pro](https://developer.apple.com/fonts/) is the system font for Apple platforms. We represent native web element styles (like option lists in [Select](/components/select/)) in our design assets in macOS styles. If you are using <strong>any theme</strong> in Paste, you will need to use it.

### Inter

[Inter](https://fonts.google.com/specimen/Inter) is a free Google font and our typeface for UI text. If you are using the <strong>Default theme</strong> in Paste, you will need to use it.
