...
The Date Picker is an input field which accepts a value in <inlineCode>MM/DD/YYYY</inlineCode> format. It is used with the <Anchor href="/component/label">Label</Anchor> and <Anchor href="/component/help-text">Help Text</Anchor> components.
