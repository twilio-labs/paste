...
<Box marginBottom="space70">
  <Callout variant="neutral">
    <CalloutHeading>Do you work on a Twilio product platform team?</CalloutHeading>
    <CalloutText>
      Navigation and information architecture are ever-evolving. Collaborate with us on defining more specific
      guidelines for your product by <Anchor href="https://github.com/twilio-labs/paste/discussions">starting a GitHub Discussion<Anchor>.
    </CalloutText>
  </Callout>
</Box>
