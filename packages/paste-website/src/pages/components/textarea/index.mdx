...
<ComponentHeader
  ...
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/components-textarea--textarea-options"
...
<DoDont>
  ...
  >
    <Box width="100%" padding="space60">
      <Label htmlFor="limited_dont">State Moto</Label>
...
<DoDont>
  <Do title="Do" body="Use help text to help users prevent errors and fill out a form field correctly." center>
    <Box width="100%" padding="space60">
      ...
      <HelpText id="help_do_help_text">Please enter: Paste is open source and contributions are welcome.</HelpText>
    </Box>
  </Do>
  <Dont title="Don't" body="Don't use placeholder text for validation instructions." center>
    <Box width="100%" padding="space60">
      ...
      <TextArea onChange={()=>{}} id="help_dont" name="help_dont" placeholder="Please enter: Paste is open source and contributions are welcome."/>
    </Box>
  </Dont>
</DoDont>
<DoDont>
  ...
  >
    <Box width="100%" padding="space60">
      <Label htmlFor="error_do" required>Header</Label>
      <TextArea onChange={()=>{}} id="error_do" name="error_do" required hasError />
      <HelpText variant="error">This is a required field. Please enter some text.</HelpText>
    </Box>
  </Do>
  <Dont
    title="Don't"
  ...
  >
    <Box width="100%" padding="space60">
      <Label htmlFor="error_dont" required>Phone Number</Label>
      <TextArea onChange={()=>{}} id="error_dont" name="error_dont" required hasError/>
      <HelpText variant="error">This field is needed to submit your document. If you don't enter any text, your submission will fail. Please enter some text into the field. This will make the field valid.</HelpText>
    </Box>
  </Dont>
</DoDont>
<DoDont>
  ...
  <Dont title="Don't" body="Don't use prefix/suffix text as a replacement for a label." center>
    <Box width="100%" padding="space60">
      <TextArea onChange={()=>{}} id="label_dont" name="label_dont" insertBefore={<div>Footer Text</div>} />
    </Box>
  </Dont>
</DoDont>
<DoDont>
  ...
  >
    <Box width="100%" padding="space60">
      ...
      <TextArea onChange={()=>{}} id="disabled_dont" name="disabled_dont" disabled value="Twilio powers the future of business communications." />
    </Box>
  </Dont>
</DoDont>
