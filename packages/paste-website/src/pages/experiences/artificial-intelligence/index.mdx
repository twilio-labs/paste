...
<Blockquote url="https://pair.withgoogle.com/guidebook/patterns#anchor-on-familiarity">
  <BlockquoteContent>
    With AI-driven products, there can be a temptation to communicate the “newness” or “magic” of the system’s
    predictions through its UI metaphors. However, unfamiliar UI touchpoints can make it harder for users to learn to
    use your system, potentially leading to degraded understanding of, or trust in, your product…Instead, anchor new
    users with familiar UI patterns and features.
  </BlockquoteContent>
