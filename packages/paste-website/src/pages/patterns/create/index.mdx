...
import CreateStandardImage from '../../../assets/images/patterns/create-standard.png';
import CreateMultiOptionImage from '../../../assets/images/patterns/create-multi-option.png';
import CreateAnchorImage from '../../../assets/images/patterns/create-anchor.png';
import CreateAnchorAsButtonImage from '../../../assets/images/patterns/create-anchor-as-button.png';
import CreateSubSectionImage from '../../../assets/images/patterns/create-sub-section.png';
import CreateCardImage from '../../../assets/images/patterns/create-card.png';
...
export const getStaticProps = async () => {
  ...
  const feature = await getFeature('Create');
  return {
    props: {
      data: {
        ...feature,
...
<Image src={CreateStandardImage} placeholder="blur" alt="table with a primary action button placed at the top right" />
...
<Image src={CreateMultiOptionImage} placeholder="blur" alt="table with a primary action button that opened a menu" />
...
<Image src={CreateAnchorImage} placeholder="blur" alt="table with a primary action link" />
...
<Image src={CreateAnchorAsButtonImage} placeholder="blur" alt="table with primary action link styled as a button" />
...
<Image src={CreateSubSectionImage} placeholder="blur" alt="table inside of a tab with a primary action button" />
...
<Callout variant="neutral" marginY="space70">
  <CalloutHeading as="h3">This pattern is coming soon!</CalloutHeading>
  <CalloutText>
