...
- [Icons] All Icon components had `React.forwardRef` added to them.

  **ACTION NEEDED**: None, but you should be aware of the change due to the fact that refs on Icons are now be assigned differently, and there is the potential for exported types to be different.

### Core 11.0.0

- [Design Tokens] The Console theme from the Design Tokens package was removed as that design language is officially deprecated.

  **ACTION NEEDED**: If you we importing the Console theme directly from the Design Tokens package you should switch your import statements to use the default, dark or SendGrid themes.
