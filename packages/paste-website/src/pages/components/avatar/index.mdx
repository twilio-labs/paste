...
<ComponentHeader
  ...
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/components-avatar--default"
...
<p>{props.pageContext.frontmatter.description} The Avatar can be sized in the same way as the <a href="/icon-system">Paste Icon</a>.</p>
...
| background-color | color-background-primary-light | No          |
