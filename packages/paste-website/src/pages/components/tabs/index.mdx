...
import {HorizontalTabsExample, FittedTabsExample} from '../../../component-examples/TabsExamples';
    ...
    <tr>
      ...
      <td>
        <UnorderedList marginBottom="space0">
          <ListItem>Always: $font-size-30, $font-weight-semibold</ListItem>
    ...
    <tr>
      ...
      <td>
        <UnorderedList marginBottom="space0">
          ...
          <ListItem>border-bottom (on hover): $color-border-primary-darker</ListItem>
          <ListItem>
            Horizontal Tabs
            <UnorderedList marginBottom="space0">
