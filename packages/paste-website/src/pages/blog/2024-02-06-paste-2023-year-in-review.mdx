...
<Callout variant="neutral">
  ...
  <CalloutText>
    <strong>80% of all Twilio Console page views</strong> are pages built entirely with Paste, from 0% 4 years ago. <strong>48% of the Segment app</strong> has migrated to Paste in 9 months.
  </CalloutText>
  <CalloutText>
