...
<ResponsiveImage src={PillGroup} alt="An example of Paste's form-pill-group component in French" />
...
<ResponsiveImage src={Badge2} alt="The new and improved Badge component in Paste" />
...
<ResponsiveImage src={FilterGroup} alt="Screenshot of a Filter Group pattern example" />
...
<ResponsiveImage src={DataViz} alt="Screenshot of a line chart using Paste data visualization tokens" />
