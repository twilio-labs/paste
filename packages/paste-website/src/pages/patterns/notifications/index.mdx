...
<Callout variant="warning">
  ...
  <CalloutText>
    This pattern is still going through feedback cycles, so if you have feedback or ideas related to this pattern, please create a <Anchor href="https://github.com/twilio-labs/paste/discussions">GitHub Discussion</Anchor> and let us know.
  </CalloutText>
</Callout>
